 ...
 **/
var mgmt = angular.module("module.Management", [
  "tokenSystem",
  "services.Keys",
  "services.Address",
  "services.Ticket",
...
mgmt.controller(
  ...
  function (
    ...
    $scope.getCostByCustomer = {
      rate: {
        idCustomer: null,
        idServiceType: null,
        idServiceTechnician: null,
      },
    };
    $scope.costs = {
      keys: { cost: 0, manual: false },
      delivery: { cost: 0, manual: false },
      service: { cost: 0, manual: false },
      total: 0,
    };
    $scope.customerSearch = {
      ...
      typeClient: "",
      isInDebt: false,
      isStockInBuilding: false,
      isStockInOffice: false,
      strict: false,
    };
      ...
      if (mode === "day") {
        ...
        for (var ticket in $scope.listTickt) {
          var currentDay = new Date(
            $scope.listTickt[ticket].created_at,
          ).setHours(0, 0, 0, 0);
    ...
    $scope.getDeliveredDayClass = function (date, mode) {
      ...
      if (mode === "day") {
        ...
        for (var ticket in $scope.listTickt) {
          var currentDay = new Date(
            $scope.listTickt[ticket].delivered_at,
          ).setHours(0, 0, 0, 0);
          //if ($scope.listTickt[ticket].idTicket=="306"){
    ...
    if ($routeParams.preference_id && $routeParams.payment_id) {
      ...
      $scope.mp.payment.data.merchant_account_id =
        $routeParams.merchant_account_id;
      $scope.mp.payment.data.preference_id = $routeParams.preference_id;
      $scope.mp.payment.data.external_reference =
      ...
      if ($scope.mp.payment.data.status == "approved") {
        inform.add(
          "El pago recibido con el numero de Id:  " +
            $scope.mp.payment.data.payment_id,
          {
            ttl: 5000,
            type: "info",
          },
      ...
      switch ($scope.swMenu) {
        case "closeWindow":
          if (confirm == 0) {
            if ($scope.isEditTicket == true) {
              $scope.mess2show =
                "Se perderan todos los cambios que no haya guardado Pedido actual, esta seguro que desea cerrar?";
            } else if ($scope.isNewUser == true) {
              $scope.mess2show =
                "Se perderan todos los datos cargados del registro actual, esta seguro que desea cancelar?";
            } else {
              $scope.mess2show =
                "Se perderan todas las modificaciones realizadas en el registro actual, esta seguro que desea cancelar la modificacion?";
            }
        ...
        case "cancelSetMgmtKeys":
          if (confirm == 0) {
            ...
            console.log(obj);
            $scope.mess2show =
              "Se perderan todos los Llaveros cargados, esta seguro que desea cancelar?";
            $("#confirmRequestModal").modal("show");
          } else if (confirm == 1) {
        ...
        case "applySetMgmtKeys":
          if (confirm == 0) {
            ...
            $("#confirmRequestModalCustom").modal({
              backdrop: "static",
              keyboard: false,
            });
            $("#confirmRequestModalCustom").on(
              "shown.bs.modal",
              function () {},
            );
          } else if (confirm == 1) {
          ...
          if (confirm == 0) {
            ...
            if ($scope.functions.isKeysEnable == "1") {
              if ($scope.functions.whereKeysAreEnable == "1") {
                ...
                $scope.mess2show =
                  "Los Llaveros han sido habilitados de forma online,     Confirmar?";
              } else {
                $scope.ticket.whereKeysAreEnableTmp = "2";
                $scope.mess2show =
                  "Los Llaveros han sido habilitados en el edificio,     Confirmar?";
              }
              console.log(
                "============================================================================",
              );
              ...
              if ($scope.functions.whereKeysAreEnable == "1") {
                $scope.mess2show =
                  "Los Llaveros no han sido habilitados de forma online, seran habilitados en el Edificio,     Confirmar?";
                $scope.ticket.whereKeysAreEnableTmp = "2";
              } else {
                $scope.ticket.whereKeysAreEnableTmp = "2";
                $scope.mess2show =
                  "Los Llaveros no han sido habilitados en el edificio,      Confirmar?";
              }
              console.log(
                "============================================================================",
              );
            ...
            if ($scope.tkupdate.isKeysEnable != null) {
              ...
              $scope.tkupdate.isKeysEnable == null &&
              ($scope.keyObj.isKeysEnable == 0 ||
                $scope.keyObj.isKeysEnable == null)
            ) {
        ...
        case "setDeliveryCompany":
          if (confirm == 0) {
            ...
            console.log($scope.keyObj);
            $scope.mess2show =
              "El Pedido sera entregado por la empresa" +
              $scope.keyObj.deliveryCompany.deliveryCompanyName +
              ",     Confirmar?";
            $("#confirmRequestModalCustom").modal({
              backdrop: "static",
              keyboard: false,
        ...
        case "setDeliveryPending":
          if (confirm == 0) {
            ...
            if ($scope.keyObj.ticket.idNewStatusKf == "4") {
              $scope.mess2show =
                'El Pedido pasara automaticamente a "Pendiente de Entrega",     Confirmar?';
            } else {
              $scope.mess2show =
                'El Pedido permanece "En Preparación", pendiente habilitación de llaveros,     Confirmar?';
            }
        ...
        case "ticketDelivered":
          if (confirm == 0) {
            ...
            $scope.mess2show =
              "El Pedido " +
              $scope.keyObj.codTicket +
              " ha sido entregado,     Confirmar?";
            $("#confirmRequestModalCustom").modal({
              backdrop: "static",
              keyboard: false,
            });
            ...
            if (
              ...
              $scope.update.ticket.isKeysEnable == "1"
            ) {
              $scope.update.ticket.idNewStatusKf = "4";
              $scope.update.ticket.idDeliveryCompanyKf = "1";
              $scope.deliveryCompanyName = (
                $scope.listDeliveryCompanies.find(
                  (s) =>
                    s.idDeliveryCompany ==
                    $scope.update.ticket.idDeliveryCompanyKf,
                ) || {}
              ).deliveryCompanyName;
              $scope.update.ticket.history.push({
                idUserKf: $scope.sysLoggedUser.idUser,
                descripcion: $scope.deliveryCompanyName,
                idCambiosTicketKf: "41",
              });
              $scope.update.ticket.history.push({
                idUserKf: $scope.sysLoggedUser.idUser,
                descripcion: null,
                idCambiosTicketKf: "42",
              });
            } else {
              $scope.update.ticket.idNewStatusKf =
                $scope.update.ticket.idStatusTicketKf;
            }
        ...
        case "ticketDeliveredBuilding":
          if (confirm == 0) {
            ...
            $scope.mess2show =
              "El Pedido " +
              $scope.keyObj.codTicket +
              " ha sido entregado en el Stock del Edificio,     Confirmar?";
            $("#confirmRequestModalCustom").modal({
              backdrop: "static",
              keyboard: false,
            });
        ...
        case "ticketDeliveredOffice":
          if (confirm == 0) {
            ...
            $scope.mess2show =
              "El Pedido " +
              $scope.keyObj.codTicket +
              " ha sido guardado en el Stock de la Oficina,     Confirmar?";
            $("#confirmRequestModalCustom").modal({
              backdrop: "static",
              keyboard: false,
            });
        ...
        case "ticketDisabledKeys":
          if (confirm == 0) {
            ...
            console.log($scope.keyObj);
            $scope.mess2show =
              "Los llaveros del Pedido " +
              $scope.keyObj.codTicket +
              " han sido deshabilitados del Control de Acceso,     Confirmar?";
            $("#confirmRequestModalCustom").modal({
              backdrop: "static",
              keyboard: false,
            });
        ...
        case "isTechnicianAssigned":
          if (confirm == 0) {
            ...
            if ($scope.functions.isTechnicianAssignedTmp) {
              $scope.mess2show =
                "El Pedido " +
                $scope.ticketDetail.codTicket +
                " sera derivado al área técnica para ser procesado.     Confirmar?";
            } else {
              $scope.mess2show =
                "No Derivar El Pedido " +
                $scope.ticketDetail.codTicket +
                " al Área Técnica.     Confirmar?";
            }
            $("#confirmRequestModalCustom").modal({
              backdrop: "static",
              keyboard: false,
            ...
            console.log($scope.functions);
            if (
              $scope.tkupdate.isTechnicianAssigned == 0 ||
              $scope.tkupdate.isTechnicianAssigned == null
            ) {
        ...
        case "update":
          if (confirm == 0) {
            ...
            //console.log(obj)
            $scope.mess2show =
              "Se actualizaran los datos del usuario: " +
              $scope.tenantObj.fname +
              " " +
              $scope.tenantObj.lname +
              " por favor,     Confirmar?";
            console.log("ID del Usuario a actualizar  : " + obj.idUser);
            console.log(
              "Nombres del Usuario a actualizar  : " +
                $scope.tenantObj.fname +
                " " +
                $scope.tenantObj.lname,
            );
        ...
        case "addNewKeyManual":
          if (confirm == 0) {
            ...
            $scope.mess2show =
              "El llavero codigo: " +
              obj.codigo +
              " sera registrado en el sistema,     Confirmar?";
        ...
        case "removeNewKey":
          if (confirm == 0) {
            ...
            $scope.mess2show =
              "El Llavero: " +
              obj.codigo +
              " sera Eliminado de la lista,     Confirmar?";
        ...
        case "confirmSetMgmtKeys":
          if (confirm == 0) {
            ...
            console.log(obj);
            $scope.mess2show =
              "La llave con el codigo: " +
              obj.codigo +
              " sera registrada en el sistema,     Confirmar?";
            console.log("Llave a registrar  : " + obj.codigo);
            console.log(
              "============================================================================",
            );
        ...
        case "approve":
          if (confirm == 0) {
            $scope.mess2show =
              "El Pedido [" + obj.codTicket + "] sera Aprobado,     Confirmar?";
            $scope.argObj = obj;
            console.log(
              "El Pedido " +
                obj.codTicket +
                " ID: " +
                obj.idTicket +
                " Sera Aprobado por el usuario: " +
                $scope.sysLoggedUser.fullNameUser,
            );
            console.log(
              "============================================================================",
            );
        ...
        case "createMPLink":
          if (confirm == 0) {
            $scope.mess2show =
              "Sera generado el Link de pago al El Pedido [" +
              obj.codTicket +
              "],     Confirmar?";
            $scope.argObj = obj;
            console.log(
        ...
        case "cancel_user":
          if (confirm == 0) {
            if (
              (obj.isKeysEnable == "1" ||
                obj.isKeysEnable == "0" ||
                obj.isKeysEnable == null) &&
              obj.idMgmtMethodKf != null &&
              (obj.building.iStockInOffice == null ||
                obj.building.iStockInOffice == "1" ||
                obj.building.isStockInBuilding == null ||
                obj.building.isStockInBuilding == "1")
            ) {
              $scope.mess2show =
                "Solicitar la cancelación del Pedido [" +
                obj.codTicket +
                "], Esta seguro que desea realizar esta acción,     Confirmar?";
            } else {
              $scope.mess2show =
                "El Pedido [" +
                obj.codTicket +
                "] sera cancelado, Esta seguro que desea realizar esta acción,     Confirmar?";
            }
            $scope.argObj = obj;
            console.log(
              "Solicitud de cancelacion del Pedido " +
                obj.codTicket +
                " ID: " +
                obj.idTicket +
        ...
        case "confirmTicketCancel":
          if (confirm == 0) {
            ...
            $timeout(function () {
              $scope.mess2show =
                "Han sido guardados los llaveros en el stock " +
                $scope.tmpTicket.stockLocation +
                ",     Confirmar?";

              $("#showModalTicketCancelNotification").modal({
                backdrop: "static",
                keyboard: false,
              });
              $("#showModalTicketCancelNotification").on(
                "shown.bs.modal",
                function () {},
              );
            }, 500);
            ...
            inform.add(
              "Se procede a completar la solicitud de cancelación del pedido.",
              {
                ttl: 15000,
                type: "info",
              },
        ...
        case "reject_cancel_user":
          if (confirm == 0) {
            $scope.mess2show =
              "Rechaza la solicitud de cancelacion del Pedido [" +
              obj.codTicket +
              "],     Confirmar?";
            $scope.argObj = obj;
            console.log(
              "Rechazar la solicitud de cancelacion del Pedido " +
                obj.codTicket +
                " ID: " +
                obj.idTicket +
                " solicitado por el usuario: " +
        ...
        case "cancel_sys":
          if (confirm == 0) {
            ...
            if (
              (obj.isKeysEnable == "0" || obj.isKeysEnable == null) &&
              obj.idMgmtMethodKf != null
            ) {
              obj.isKeysEnableRequested = true;
              $scope.mess2show =
                "Los llaveros asignados al pedido [" +
                obj.codTicket +
                "], han sido habilitados,     Confirmar?";
            } else {
              $scope.mess2show =
                "El Pedido [" +
                obj.codTicket +
            ...
            $("#confirmRequestModalCustom").modal("hide");
            if (
              ($scope.argObj.building.isStockInOffice == "1" ||
                $scope.argObj.building.isStockInBuilding == "1") &&
              ($scope.argObj.idMgmtMethodKf == "1" ||
                $scope.argObj.idMgmtMethodKf == "2") &&
              ($scope.argObj.isKeysEnable == null ||
                $scope.argObj.isKeysEnable == "0" ||
                $scope.argObj.isKeysEnable == "1")
            ) {
              $scope.argObj.isKeysEnable =
                $scope.argObj.isKeysEnableRequested &&
                ($scope.argObj.isKeysEnable == "0" ||
                  $scope.argObj.isKeysEnable == null) &&
                $scope.argObj.idMgmtMethodKf != null
                  ? "1"
                  : $scope.argObj.isKeysEnable;
        ...
        case "apply_ticket_delivery_change":
          if (confirm == 0) {
            $scope.mess2show =
              "El Metodo de envio del pedido [" +
              obj.selected.codTicket +
              "] sera modificado, este cambio puede generar cargos adicionales, Esta seguro que desea realizar el cambio, Confirmar?";
            $scope.argObj = obj;
            console.log(
              "El Metodo de envio del pedido " +
                obj.selected.codTicket +
                " ID: " +
                obj.selected.idTicket +
                " Solicitado por el usuario: " +
                $scope.sysLoggedUser.fullNameUser,
            );
            console.log(
        ...
        case "ticket_manual_payment":
          ...
          if (confirm == 0) {
            $scope.mess2show =
              "El Pago manual para pedido [" +
              obj.selected.codTicket +
              "] sera registrado, Esta seguro que desea realizar esta acción, Confirmar?";
            $scope.argObj = obj;
            console.log(
              "El Pago manual para pedido " +
                obj.selected.codTicket +
        ...
        case "exportBillingExcelList":
          if (confirm == 0) {
            $scope.mess2show =
              "Sera iniciado el proceso de facturación y la descarga para el siguiente listado de pedidos, Confirmar?";
            $scope.argObj = obj;
            console.log(
              "============================================================================",
            );
        ...
        case "exportOnInternalRouteExcelList":
          if (confirm == 0) {
            ...
            if ($scope.selectedTicketList.length >= 1) {
              $scope.mess2show =
                "Sera descargado el siguiente listado de (" +
                $scope.selectedTicketList.length +
                ") pedidos en el formato de envío interno, Confirmar?";
              ...
              inform.add(
                "Debe seleccionar al menos un pedido de la lista para generar y descargar el archivo.",
                {
                  ttl: 5000,
                  type: "info",
                },
            ...
            $scope.mainSwitchFn(
              "exportOnInternalRouteExcelList",
              $scope.argObj,
            );
            $("#confirmRequestModal").modal("hide");
            //console.log($scope.argObj);
          ...
          if (confirm == 0) {
            ...
            if ($scope.selectedTicketList.length >= 1) {
              $scope.mess2show =
                "Sera descargado el siguiente listado de (" +
                $scope.selectedTicketList.length +
                ") pedidos en el formato de envío externo, Confirmar?";
              $scope.argObj = $scope.selectedTicketList;
              console.log(
                "============================================================================",
              );
            ...
            $scope.mainSwitchFn(
              "exportOnExternalRouteExcelList",
              $scope.argObj,
            );
            $("#confirmRequestModal").modal("hide");
            //console.log($scope.argObj);
        ...
        case "ticket_refunds_complete":
          if (confirm == 0) {
            $scope.mess2show =
              "El pago de reintegro del pedido [" +
              $scope.tkupdate.codTicket +
              "] ha sido completado, Confirmar?";
            $scope.argObj = obj;
            console.log(
              "El pago de reintegro del pedido " +
                $scope.tkupdate.codTicket +
                " ID: " +
                $scope.tkupdate.idTicket +
                " Solicitado por el usuario: " +
                $scope.sysLoggedUser.fullNameUser,
            );
            console.log(
        ...
        case "change_ticket_status_single":
          if (confirm == 0) {
            ...
            $scope.mess2show =
              ...
              obj.codTicket +
              "] cambiara a Estado: " +
              obj.newTicketStatus.statusName +
              ", Confirmar?";
            console.log(
              "El estado del pedido " +
                obj.codTicket +
            ...
            switch ($scope.argObj.newTicketStatus.idStatus) {
              case "1":
                $scope.mainSwitchFn("applyTicketDelivered", $scope.argObj);
                break;
              case "5":
              ...
              default:
                $scope.mainSwitchFn(
                  "apply_change_ticket_status_single",
                  $scope.argObj,
                );
            }
        ...
        case "change_ticket_status_multi":
          if (confirm == 0) {
            $scope.mess2show =
              "El estado de los pedidos seleccionados sera modificado, Esta seguro que desea realizar el cambio, Confirmar?";
            $scope.argObj = obj;
            console.log(
              "============================================================================",
            );
            ...
            $scope.mainSwitchFn(
              "apply_change_ticket_status_multi",
              $scope.argObj,
            );
            $("#confirmRequestModal").modal("hide");
            //console.log($scope.argObj);
        ...
        case "upload_billing_ticket":
          if (confirm == 0) {
            $scope.mess2show =
              "La factura [" +
              obj.name +
              "] sera cargada y asociada al ticket, Esta seguro que desea realizar la carga de la factura, Confirmar?";
            $scope.argObj = obj;
            console.log(
              "Factura Nombre " +
                obj.name +
        ...
        case "deleteSingleFile":
          if (confirm == 0) {
            $scope.delFile = obj;
            $scope.mess2show =
              "El archivo " + obj.title + " sera eliminado.     Confirmar?";

            console.log(
              "Archivo a eliminar ID: " +
                obj.idClientFiles +
                " File: " +
                obj.title,
            );
        ...
        case "approveDepto":
          if (confirm == 0) {
            ...
            console.log(obj);
            var department =
              obj.department.floor + "-" + obj.department.departament;
            if (obj.userRequestBy.idTypeTenantKf == "1") {
              $scope.mess2show =
                "El Propietario: " +
                $scope.tenantObj.userRequestBy.fullNameUser +
                " sera autorizado al Departamento: " +
            ...
            console.log(
              "ID del usuario a asociar y aprobar         : " +
                $scope.tenantObj.userRequestBy.idUser,
            );
            console.log(
              "Nombres del Habitante a asociar y aprobar  : " +
                $scope.tenantObj.userRequestBy.fullNameUser,
            );
            console.log(
              "============================================================================",
        ...
        case "updateComment":
          if (confirm == 0) {
            ...
            console.log(obj);
            $scope.mess2show =
              "Desea actualizar las observaciones/comentarios del pedido, Confirmar ?";
            //console.log(obj);
            $("#confirmRequestModal").modal("toggle");
          } else if (confirm == 1) {
    ...
    $scope.getAttendantListFn = function (idAddress) {
      ...
      userServices.attendantsOnlyList(idAddress).then(function (response) {
        if (response.status == 200) {
          ...
          $scope.attendantListByAddress = [];
          inform.add(
            "No se encontraron Encargados asociados al consorcio seleccionado. ",
            {
              ttl: 5000,
              type: "info",
            },
      ...
      ticketServices.getTicketStatusTypeList().then(function (response) {
        if (response.status == 200) {
          ...
          const sortedList = dataList.sort(
            (a, b) => orderMap[a.idStatus] - orderMap[b.idStatus],
          );
    ...
    $scope.getContractsByCustomerIdFn = function (idClient) {
      $scope.rsContractsListByCustomerIdData = [];
      ContractServices.getContractListByCustomerId(idClient).then(
        function (response) {
          console.log(response);
          if (response.status == 200) {
            ...
            $scope.rsTypeOfMaintenanceData.forEach(function (maintenance) {
              maintenanceTypeMap[maintenance.idTypeMaintenance] =
            ...
            response.data.forEach(function (item) {
              if (item.idStatusFk == "1") {
                ...
                item.typeMaintenance =
                  maintenanceTypeMap[item.maintenanceType] ||
    ...
    $scope.getListContractServicesFn = function (idContract, opt) {
      serviceServices
        .getServiceListByIdContract(idContract)
        .then(function (data) {
    ...
    $scope.getListContractServices2Fn = function (contracts) {
      ...
      for (var contract in contracts) {
        ...
        serviceServices
          .getServiceListByIdContract(contracts[contract].idContrato)
    ...
    $scope.getKeysAssociatedToACustomerFn = function (idClient) {
      ...
      CustomerServices.getKeysAssociatedToACustomerService(idClient).then(
        function (response) {
          if (response.status == 200) {
            ...
            $timeout(function () {
              $scope.select.products.selected = {
                idStatusFk: $scope.rsKeyProductsData[0].idStatusFk,
                contractStatus: $scope.rsKeyProductsData[0].contractStatus,
                serviceName: $scope.rsKeyProductsData[0].serviceName,
                idProduct: $scope.rsKeyProductsData[0].idProduct,
                descriptionProduct:
                  $scope.rsKeyProductsData[0].descriptionProduct,
                codigoFabric: $scope.rsKeyProductsData[0].codigoFabric,
                brand: $scope.rsKeyProductsData[0].brand,
                model: $scope.rsKeyProductsData[0].model,
                idProductClassificationFk:
                  $scope.rsKeyProductsData[0].idProductClassificationFk,
                isNumberSerieFabric:
                  $scope.rsKeyProductsData[0].isNumberSerieFabric,
                isNumberSerieInternal:
                  $scope.rsKeyProductsData[0].isNumberSerieInternal,
                isDateExpiration: $scope.rsKeyProductsData[0].isDateExpiration,
                isControlSchedule:
                  $scope.rsKeyProductsData[0].isControlSchedule,
                isRequestNumber: $scope.rsKeyProductsData[0].isRequestNumber,
                priceFabric: $scope.rsKeyProductsData[0].priceFabric,
                classification: $scope.rsKeyProductsData[0].classification,
              };
    ...
    $scope.getControlAccessDoorsAssociatedToACustomerFn = function (idClient) {
      ...
      CustomerServices.getControlAccessDoorsAssociatedToACustomerServices(
        idClient,
      ).then(function (response) {
        console.log(response.data);
        if (response.status == 200) {
          ...
          for (var item in $scope.tkupdate.accessControlDoors) {
            const itHasHttpProto =
              $scope.tkupdate.accessControlDoors[item].controlAccessInternet
                .addressVpn != null &&
              $scope.tkupdate.accessControlDoors[item].controlAccessInternet
                .addressVpn != undefined
                ? regexProtocol.test(
                    $scope.tkupdate.accessControlDoors[item]
                      .controlAccessInternet.addressVpn,
                  )
                : null;
            const itHasPortInURL =
              $scope.tkupdate.accessControlDoors[item].controlAccessInternet
                .addressVpn != null &&
              $scope.tkupdate.accessControlDoors[item].controlAccessInternet
                .addressVpn != undefined
            ...
            if (itHasPortInURL && itHasPortInURL != null) {
              ...
              if (extractedPort != vpnPortDefined) {
                inform.add(
                  "La dirección VPN contiene un puerto (" +
                    extractedPort +
                    ") diferente al puerto VPN (" +
                    vpnPortDefined +
                    ") especificado en el campo o al puerto por defecto (80).",
                  {
                    ttl: 6000,
                    type: "warning",
                  },
      ...
      try {
        ...
        ticketServices.ticketById(idTicket).then(function (response) {
          if (response.status == 200) {
            ...
            $scope.getContractsByCustomerIdFn(
              $scope.tkupdate.building.idClient,
            );
            $scope.getKeysAssociatedToACustomerFn(
              $scope.tkupdate.building.idClient,
            );
            $scope.getControlAccessDoorsAssociatedToACustomerFn(
              $scope.tkupdate.building.idClient,
            );
            if (
              $scope.tkupdate.idMgmtMethodKf != null &&
              $scope.tkupdate.idMgmtMethodKf != undefined
            ) {
              switch ($scope.tkupdate.idTypeRequestFor) {
                case "1":
                  ...
                  console.log(
                    "⚡ idMgmtMethodKf =",
                    $scope.tkupdate.idMgmtMethodKf,
                  );
                  console.log(
                    "⚡ tkupdate.keys has keychain?",
                    $scope.tkupdate.keys.some((k) => k.keychain != null),
                  );
                  $scope
                    .getKeychainListFnNew(
                      $scope.tkupdate.building.idClient,
                      null,
                      $scope.tkupdate.idTypeRequestFor,
                      "-1",
                      $scope.tkupdate.department.idClientDepartament,
                      null,
                      null,
                      null,
                      null,
                        ...
                        if (response.status == 200) {
                          ...
                          $scope.rsAllKeychainListDataFiltered = angular.copy(
                            (response.data.tb_keychain || []).filter(
                              (s) =>
                                s.tb_ticket_keychain &&
                                s.tb_ticket_keychain.idTicketKf ==
                                  $scope.tkupdate.idTicket,
                            ),
                          );
                          ...
                          for (var key in $scope.rsAllKeychainListDataFiltered) {
                            $scope.rsAllKeychainListDataFiltered[key].selected =
                              true;
                            $scope.rsAllKeychainListDataFiltered[key].disabled =
                              true;
                          }
                        } else if (response.status == 404) {
                          ...
                          inform.add(
                            "[Error]: " +
                              response.status +
                              ", Ha ocurrido un error en la comunicacion con el servidor, contacta el area de soporte. ",
                            {
                              ttl: 5000,
                              type: "danger",
                            },
            ...
            if (
              ($scope.tkupdate.building.isStockInBuilding != "0" &&
                $scope.tkupdate.building.isStockInBuilding != null &&
                $scope.tkupdate.building.isStockInBuilding != undefined) ||
              ($scope.tkupdate.building.isStockInOffice != "0" &&
                $scope.tkupdate.building.isStockInOffice != null &&
                $scope.tkupdate.building.isStockInOffice != undefined)
            ) {
                    ...
                    if (response.status == 200) {
                      ...
                      $scope.rsAllKeychainListDataStockFiltered = angular.copy(
                        $scope.existingStockKeys.filter(
                          (s) =>
                            s.idProductKf ==
                            $scope.tkupdate.keys[0].idProductKf,
                        ),
                      );
            ...
            $scope.ticket.keysMethod =
              $scope.tkupdate.keysMethod != null
                ? $scope.tkupdate.keysMethod
                : { name: null };
            $scope.ticket.keysMethodSelected =
              $scope.tkupdate.keysMethod != null
                ? $scope.tkupdate.keysMethod
                : null;
            ...
            $scope.functions.isTechnicianAssignedTmp =
              $scope.tkupdate.isTechnicianAssigned == 1 ? true : false;
            if ($scope.tkupdate.idDeliveryCompanyKf != null) {
              $timeout(function () {
                ...
                $scope.tkupdate.deliveryCompany =
                  $scope.listDeliveryCompanies.find(
                    (s) =>
                      s.idDeliveryCompany ==
                      $scope.tkupdate.idDeliveryCompanyKf,
                  );
              }, 1500);
            }
            if ($scope.tkupdate.whereKeysAreEnable === null) {
              ...
              $scope.functions.whereKeysAreEnable =
                $scope.tkupdate.whereKeysAreEnable;
              $scope.ticket.whereKeysAreEnable =
                $scope.tkupdate.whereKeysAreEnable;
            }
        ...
        console.log($scope.functions);
        console.log(
          "$scope.rsNewKeychainList lenght: " + $scope.rsNewKeychainList.length,
        );
        console.log(
          "$scope.rsExistingKeyList lenght: " + $scope.rsExistingKeyList.length,
        );
        console.log(
          "$scope.list_new_keys lenght:     " + $scope.list_new_keys.length,
        );
      } catch (e) {
    ...
    $scope.setOptionType = function (obj) {
      ...
      //console.log(elem[0])
      if ($scope.tkupdate.keysMethod === null) {
    ...
    $scope.getDeliveryTypesFn_filter = function (obj) {
      ...
      ticketServices.typeDelivery().then(function (response) {
        if (response.status == 200) {
          ...
          $scope.typedelivery_filter = [];
          inform.add(
            "No hay tipos de deliverys registrados, contacte al area de soporte de BSS.",
            {
              ttl: 5000,
              type: "warning",
            },
    ...
    $scope.getDeliveryCompaniesFn = function (obj) {
      ...
      ticketServices.deliveryCompanies().then(function (response) {
        if (response.status == 200) {
          ...
          $scope.listDeliveryCompanies_filter = [];
          inform.add(
            "No hay empresas de delivery registrados, contacte al area de soporte de BSS.",
            {
              ttl: 5000,
              type: "warning",
            },
    ...
    $scope.sysRequestCancellationTicketFn = function (data) {
      ...
      ticketServices.requestCancelTicket(data).then(function (response) {
        ...
        if (response.status == 200) {
          ...
          inform.add(
            "La solicitud de cancelación del pedido N°: " +
              data.ticket.codTicket +
          ...
          console.log(
            "Ticket Cancellation request has failed, contact administrator",
          );
          inform.add("Error: [500] Contacta al area de soporte. ", {
            ttl: 5000,
            type: "danger",
    ...
    $scope.sysRejectRequestCancellationTicketFn = function (data) {
      ...
      ticketServices.rejectRequestCancelTicket(data).then(function (response) {
        ...
        if (response.status == 200) {
          ...
          console.log(
            "Reject ticket Cancellation request has failed, contact administrator",
          );
          inform.add("Error: [500] Contacta al area de soporte. ", {
            ttl: 5000,
            type: "danger",
    ...
    $scope.sysCancelTicketFn = function (data) {
      ...
      ticketServices.cancelTicket(data).then(function (response) {
        ...
        if (response.status == 200) {
          ...
          inform.add(
            "El pedido N°: " + data.ticket.codTicket + " ha sido cancelado.",
            {
              ttl: 3000,
              type: "success",
            },
          ...
          console.log(
            "Ticket cancel process has failed, contact administrator",
          );
          inform.add(
            "Error: [404] CTicket no ha sido cancelado conctate el area de soporte. ",
            {
              ttl: 5000,
              type: "danger",
            },
    ...
    $scope.sysCheckTicketBeforeCancelFn = function (ticketID, idUser) {
      ...
      ticketServices.checkTicketBeforeCancel(ticketID).then(function (data) {
        ...
        if ($scope.ticketResult == 1) {
          ...
          $("#CancelNotificationModal").modal("show");
          inform.add(
            "Se inicia la cancelacion que sera enviada para aprobacion.",
            {
              ttl: 3000,
              type: "warning",
            },
    ...
    $scope.sysRejectedChgOrCancelTicketFn = function (rsData) {
      console.clear();
      ticketServices
        .rejectedChOrCanTicket(rsData.idTicket, rsData.isChgOrCancel)
        .then(function (data) {
          $scope.ticketResult = data;
          if ($scope.ticketResult) {
            if (rsData.isChgOrCancel == 1) {
              console.log(
                "[sysRejectedCancelTicketFn] => TICKET CHANGE REJECTED SUCCESSFULLY",
              );
            } else if (rsData.isChgOrCancel == 0) {
              console.log(
                "[sysRejectedCancelTicketFn] => TICKET CANCEL REJECTED SUCCESSFULLY",
              );
            }
            $scope.dhboard();
          } else {
            inform.add(
              "Ticket no ha sido cancelado conctate el area de soporte.",
              {
                ttl: 3000,
                type: "warning",
              },
    ...
    $scope.sysUpdateTmpTicketFn = function (data) {
      ...
      ticketServices.updateTmpTicket(data).then(function (data) {
        ...
        if ($scope.ticketResult) {
          ...
          inform.add(
            "Ticket no ha sido actualizado conctate el area de soporte.",
            {
              ttl: 3000,
              type: "warning",
            },
    ...
    $scope.sysTempDelivCancelDataFn = function (option) {
      switch (option) {
        case 1:
          ...
          $scope.rsTemp.ticket.idUserAttendantKfDelivery =
            $scope.tkupdate.idUserAttendantKfDelivery;
          $scope.rsTemp.ticket.thirdPersonNames =
            $scope.tkupdate.thirdPersonNames;
          $scope.rsTemp.ticket.thirdPersonPhone =
            $scope.tkupdate.thirdPersonPhone;
          $scope.rsTemp.ticket.thirdPersonId = $scope.tkupdate.thirdPersonId;
          $scope.rsTemp.ticket.idTypeDeliveryKf =
            $scope.tkupdate.idTypeDeliveryKf;
        ...
        case 2:
          ...
          $scope.rsTemp.ticket.idTicketKf = $scope.tkupdate.idTicket;
          $scope.rsTemp.ticket.idUserRequestChOrCancel = $scope.sessionIdUser;
          $scope.rsTemp.ticket.reasonForCancelTicket =
            $scope.tkupdate.reasonForCancelTicket;
        ...
        case 3:
          ...
          $scope.rsTemp.ticket.reasonForCancelTicket =
            $scope.tkupdate.reasonForCancelTicket;
          $scope.rsTemp.ticket.idStatusTicketKfOld =
            $scope.tkupdate.idStatusTicketKf;
    ...
    $scope.sysAddDeliveryDataTmpFn = function ($http, $scope, option) {
      ...
      ticketServices.tmpDeliveryData($scope.rsTemp).then(function (data) {
        ...
        if ($scope.ticketResult) {
          ...
          if (option == 1) {
            $scope.rsData.ticket.isChangeDeliverylRequested =
              $scope.tktmporal.isChangeDeliverylRequested;
            $scope.rsData.ticket.idUserHasChangeTicket = null;
          } else if (option == 2) {
            $scope.rsData.ticket.isCancelRequested =
              $scope.tktmporal.isCancelRequested;
          ...
          ticketServices.updateTicket($scope.rsData).then(function (data) {
            ...
            if ($scope.ticketResult) {
              if (option == 1) {
                ...
                inform.add(
                  "Solicitud de modificacion de envio ha sido enviada satisfactoriamente.",
                  {
                    ttl: 3000,
                    type: "success",
                  },
                ...
                inform.add(
                  "Solicitud de cancelacion enviada satisfactoriamente.",
                  {
                    ttl: 3000,
                  },
                );
              ...
              inform.add(
                "Ticket no ha sido actualizado, conctacta a el area de soporte.",
                {
                  ttl: 3000,
                  type: "warning",
                },
    ...
    $scope.sendTicketComment2Update = function () {
      ...
      $scope.rsData.ticket.descriptionComment =
      ...
      ticketServices.updateTicket($scope.rsData).then(function (data) {
        ...
        if ($scope.ticketResult) {
          ...
          inform.add(
            "El comentario sobre el ticket ha sido actualizado satisfactoriamente.",
            {
              ttl: 3000,
              type: "success",
            },
    ...
    $scope.sendTicketDescription2Update = function () {
      ...
      ticketServices.updateTicket($scope.rsData).then(function (data) {
        ...
        if ($scope.ticketResult) {
          console.log("TICKET UPDATED SUCCESSFULLY");
          inform.add(
            "La descripción del servicio ha sido actualizado satisfactoriamente.",
            {
              ttl: 3000,
              type: "success",
            },
    ...
    $scope.removeFilterFn = function (option) {
      switch (option) {
        ...
        case 2:
          if (
            $scope.customerFound.idClientTypeFk == "2" ||
            $scope.customerFound.idClientTypeFk == "4"
          ) {
            $scope.filterCompanyKf.selected = undefined;
            $scope.customerSearch.name = undefined;
            $scope.customerFound = {};
    ...
    $scope.systemChgValueFn = function (value, bol) {
      switch (value) {
        case "comment":
          ...
          if (bol == true) {
            $scope.tkupdate.descriptionCommentTmp =
              $scope.tkupdate.descriptionComment;
            $scope.tkupdate.descriptionComment = "";
          } else {
            $scope.tkupdate.descriptionComment =
        ...
        case "descript":
          ...
          if (bol == true) {
            $scope.tkupdate.descriptionOrderTmp =
      ...
      switch (value) {
        case 0:
          ...
          ticketServices.getTickets2Check(0).then(function (data) {
            ...
            if ($scope.rsJsonData) {
              console.log(
                "[sysChkChangeOrCancel] => Tickets with change or cancel rejected found",
              );
              var listOfTicketsLength = $scope.rsJsonData.length;
              for (i = 0; i < listOfTicketsLength; i++) {
                //console.log("for i: "+i);
                if (
                  $scope.rsJsonData[i].isCancelRequested &&
                  $scope.rsJsonData[i].tmp_isCancelApproved == 0
                ) {
                  $scope.rsTmp = {};
                  ...
                  console.log(
                    "[sysChkChangeOrCancel] => Cancel TIckets rejected Found => Updating tickets",
                  );
                  $scope.sysTmpChangeAppliedFn(
                    $scope.rsJsonData[i].idTmpDeliveryData,
                    0,
                  );
                } else if (
                  $scope.rsJsonData[i].isChangeDeliverylRequested &&
                  $scope.rsJsonData[i].tmp_isChApproved == 0
                ) {
                  $scope.rsTmp = {};
                  $scope.rsTmp.idTicket = $scope.rsJsonData[i].idTicket;
                  ...
                  $scope.sysRejectedChgOrCancelTicketFn($scope.rsTmp);
                  console.log(
                    "[sysChkChangeOrCancel] => Change TIckets Approved Found => Updating tickets",
                  );
                  $scope.sysTmpChangeAppliedFn(
                    $scope.rsJsonData[i].idTmpDeliveryData,
                    0,
              ...
              console.log(
                "[sysChkChangeOrCancel] => No changes or cancel Tickets rejected Found.",
              );
            }
          });
          break;
        case 1:
          ...
          ticketServices.getTickets2Check(1).then(function (data) {
            ...
            if ($scope.rsJsonData) {
              console.log(
                "[sysChkChangeOrCancel] => Tickets with change or cancel approved found",
              );
              var listOfTicketsLength = $scope.rsJsonData.length;
              for (i = 0; i < listOfTicketsLength; i++) {
                //console.log("for i: "+i);
                if (
                  $scope.rsJsonData[i].isCancelRequested &&
                  $scope.rsJsonData[i].tmp_isCancelApproved == 1
                ) {
                  $scope.rsTmp = {};
                  $scope.rsTmp.ticket = $scope.rsJsonData[i];
                  $scope.rsTmp.ticket.idTicket = $scope.rsJsonData[i].idTicket;
                  $scope.rsTmp.ticket.idUserCancelTicket =
                    $scope.rsJsonData[i].tmp_idUserRequestChOrCancel;
                  $scope.rsTmp.ticket.reasonForCancelTicket =
                    $scope.rsJsonData[i].tmp_reasonForCancelTicket;

                  $scope.sysCancelTicketFn($scope.rsTmp);
                  console.log(
                    "[sysChkChangeOrCancel] => Cancel TIckets Approved Found => Updating tickets",
                  );
                  ...
                  $scope.rsJsonData[i].isChangeDeliverylRequested &&
                  $scope.rsJsonData[i].tmp_isChApproved == 1
                ) {
                  $scope.rsTmp = {};
                  $scope.rsTmp.ticket = $scope.rsJsonData[i];
                  $scope.rsTmp.ticket.idTicket = $scope.rsJsonData[i].idTicket;
                  $scope.rsTmp.ticket.idUserHasChangeTicket =
                    $scope.rsJsonData[i].tmp_idUserRequestChOrCancel;
                  $scope.rsTmp.ticket.thirdPersonNames =
                    $scope.rsJsonData[i].tmp_thirdPersonNames;
                  $scope.rsTmp.ticket.thirdPersonPhone =
                    $scope.rsJsonData[i].tmp_thirdPersonPhone;
                  $scope.rsTmp.ticket.thirdPersonId =
                    $scope.rsJsonData[i].tmp_thirdPersonId;
                  $scope.rsTmp.ticket.idUserAttendantKfDelivery =
                    $scope.rsJsonData[i].tmp_idUserAttendantKfDelivery;
                  $scope.rsTmp.ticket.idTypeDeliveryKf =
                    $scope.rsJsonData[i].tmp_idTypeDeliveryKf;
                  $scope.rsTmp.ticket.totalService =
                    $scope.rsJsonData[i].tmp_totalService;
                  $scope.rsTmp.ticket.idWhoPickUpKf =
                    $scope.rsJsonData[i].tmp_idWhoPickUpKf;
              ...
              console.log(
                "[sysChkChangeOrCancel] => No changes or cancel Tickets Approved Found.",
              );
            }
          });
          break;
    ...
    $scope.getAddressByidTenantFn = function (idUser, idTypeTenant, idStatus) {
      addressServices
        .getAddressByidTenant(idUser, idTypeTenant, idStatus)
        .then(function (response) {
          if (response.status == 200) {
    ...
    $scope.getPaymentsTypeFn = function () {
      ...
      ticketServices.paymentsType().then(function (response) {
        if (response.status == 200) {
          ...
          $scope.paymentsType = [];
          inform.add(
            "No hay tipos de Pagos registrados, contacte al area de soporte de BSS.",
            {
              ttl: 5000,
              type: "warning",
            },
    ...
    $scope.getManualPaymentsTypeFn = function () {
      ...
      ticketServices.manualPaymentsType().then(function (response) {
        if (response.status == 200) {
          ...
          $scope.manualPaymentsType = [];
          inform.add(
            "No hay tipos de Pagos manuales registrados, contacte al area de soporte de BSS.",
            {
              ttl: 5000,
              type: "warning",
            },
    ...
    $scope.getServiceCostByCustomerFn = function (data) {
      serviceServices.getServiceCostByCustomer(data).then(function (response) {
        if (response.status == 200) {
          ...
          inform.add(
            "El consorcio no presenta costos de servicios asociados, contacte al area de soporte de BSS.",
            {
              ttl: 3000,
              type: "warning",
            },
    ...
    $scope.checkControlAccessStateFn = function (idClient) {
      $scope.rsCustomerInterneServices = [];
      //console.log("Getting --> ControlAccessDoorsAssociatedToACustomerFn");
      CustomerServices.getCheckControlAccessState(idClient).then(
        function (response) {
          if (response.status == 200) {
            console.log(response.data);
            if (
              $scope.ticket.building != undefined &&
              ($scope.ticket.building.initial_delivery.length == 0 ||
                ($scope.ticket.building.initial_delivery.length == 1 &&
                  $scope.ticket.building.initial_delivery[0].expiration_state !=
                    undefined &&
                  !$scope.ticket.building.initial_delivery[0]
                    .expiration_state) ||
                ($scope.ticket.building.isStockInBuilding != null &&
                  $scope.ticket.building.isStockInBuilding != "0") ||
                ($scope.ticket.building.isStockInOffice != null &&
                  $scope.ticket.building.isStockInOffice != "0"))
            ) {
              for (var srv in response.data) {
                console.info(response.data[srv]);
                if (
                  response.data[srv].idServiceAsociateFk_array != undefined &&
                  response.data[srv].idServiceAsociateFk_array.length > 0
                ) {
                  console.info(
                    response.data[srv].idServiceAsociateFk_array.length,
                  );
                  console.info(response.data[srv].idServiceAsociateFk_array);
                  console.info(response.data[srv].idServiceAsociateFk_array[0]);
                  for (var srva in response.data[srv]
                    .idServiceAsociateFk_array) {
                    console.info(
                      response.data[srv].idServiceAsociateFk_array[srva],
                    );
                    if (
                      response.data[srv].idServiceAsociateFk_array[srva] !=
                        null &&
                      response.data[srv].idServiceAsociateFk_array[srva][0]
                        .idClientServicesAccessControl != undefined
                    ) {
                      $scope.getCostByCustomer.rate.deviceIsOnline = "1";
                      $scope.getCostByCustomer.rate.hasStock = "1";
                      console.log($scope.getCostByCustomer);
                      $scope.getServiceCostByCustomerFn(
                        $scope.getCostByCustomer,
                      );
            ...
            if (
              ...
              ($scope.ticket.building.initial_delivery.length == 0 ||
                ...
                ($scope.ticket.building.isStockInBuilding == "1" &&
                  $scope.ticket.building.isStockInBuilding != null &&
                  $scope.ticket.building.isStockInBuilding != "0") ||
                ($scope.ticket.building.isStockInOffice == "1" &&
                  $scope.ticket.building.isStockInOffice != null &&
                  $scope.ticket.building.isStockInOffice != "0"))
            ) {
              console.log($scope.ticket.building);
    ...
    $scope.getAdminListFn = function () {
      ...
      $scope.globalGetCustomerListFn(null, "0", 1, "", "", null).then(
        function (data) {
    ...
    $scope.getCompaniesListFn = function () {
      $scope.companiesList = [];
      $scope.globalGetCustomerListFn(null, "0", 3, "", "", null).then(
        function (data) {
    ...
    $scope.getKeychainListFnNew = function (
      idClientKf,
      create_at,
      idCategoryKf,
      idKeychainStatusKf,
      ...
      var idClientKf =
        idClientKf != undefined && idClientKf != null ? idClientKf : null;
      var idCategoryKf =
        idCategoryKf != undefined && idCategoryKf != "" && idCategoryKf != null
          ? idCategoryKf
          : null;
      var idKeychainStatusKf =
        idKeychainStatusKf != undefined &&
        idKeychainStatusKf != "" &&
        idKeychainStatusKf != null
          ? idKeychainStatusKf
          : null;
      var idDepartmenKf =
        idDepartmenKf != undefined &&
        idDepartmenKf != "" &&
        idDepartmenKf != null
          ? idDepartmenKf
          : null;
      var idReasonKf =
        idReasonKf != undefined && idReasonKf != "" && idReasonKf != null
          ? idReasonKf
          : null;
      var sysLoggedUserProfile = $scope.sysLoggedUser.idProfileKf;
      var codeSearch =
        codeSearch != undefined && codeSearch != "" && codeSearch != null
          ? codeSearch
          : null;
      var create_at =
        create_at != undefined && create_at != "" && create_at != null
          ? create_at
          : null;
      var start = start != undefined && start != null && !strict ? start : "";
      var limit = limit != undefined && limit != null && !strict ? limit : "";
      var strict =
        strict != false && strict != undefined && strict != null
          ? strict
          : null;
      var totalCount =
        totalCount != false && totalCount != undefined && totalCount != null
          ? totalCount
          : null;
      var getTicketKeychainKf =
        getTicketKeychainKf != undefined &&
        getTicketKeychainKf != "" &&
      ...
      return KeysServices.getKeychainList($scope.keychainSearch).then(
        function (response) {
          return response;
        },
      );
    };
    $scope.getKeychainListFn = function (
      idClientKf,
      create_at,
      idCategoryKf,
      idKeychainStatusKf,
      ...
      KeysServices.getKeychainList($scope.keychainSearch).then(
        function (response) {
          console.log(response);
          if (response.status == 200) {
            if (showFull) {
    ...
    $scope.getKeychainProcessFn = function (
      idTypeTicketKf,
      idClientKf,
      create_at,
      idCategoryKf,
      ...
      KeysServices.getKeychainProcess($scope.keychainProcessSearch).then(
        function (response) {
          if (response.status == 200) {
            $scope.rsAllKeychainProcessesData =
              response.data.tb_keychain_process_events;
            if (response.data.totalCount != undefined) {
              $scope.pagination.totalCount = response.data.totalCount;
            }
            console.log(response.data);
    ...
    $scope.pageChanged = function () {
      ...
      var pagIndex =
        ($scope.pagination.pageIndex - 1) * $scope.pagination.pageSizeSelected;
      var idKeychainStatus =
        $scope.select.keychainStatus != undefined &&
        $scope.select.keychainStatus != null &&
        $scope.select.keychainStatus != ""
          ? $scope.select.keychainStatus.idKeychainStatus
          : null;
      var codeSearch =
        $scope.select.codeSearch != undefined &&
        $scope.select.codeSearch != null &&
        $scope.select.codeSearch != ""
          ? $scope.select.codeSearch
          : null;
      var idReasonKf =
        $scope.select.keychainStatus != undefined &&
        $scope.select.keychainStatus != null &&
        $scope.select.keychainStatus != "" &&
        $scope.select.reasonKf != undefined &&
        $scope.select.reasonKf != null &&
        $scope.select.reasonKf != ""
          ? $scope.select.reasonKf.idReasonDisabledItem
          : null;
      if ($scope.sysContent == "listKeys") {
        $scope.getKeychainListFn(
          $scope.customerFound.idClient,
          null,
          $scope.select.filterCategoryKey,
          idKeychainStatus,
          $scope.select.idDepartmenKf,
          idReasonKf,
          codeSearch,
          pagIndex,
          $scope.pagination.pageSizeSelected,
          false,
          false,
        );
      } else {
        $scope.getKeychainProcessFn(
          $scope.select.idTypeTicketKf,
          $scope.customerFound.idClient,
          null,
          $scope.select.filterCategoryKey,
          pagIndex,
    ...
    $scope.getDeptoListByAddress = function (idAddress) {
      if (idAddress != undefined) {
        $scope.ListDpto = [];
        var idStatusFk = "-1";
        DepartmentsServices.byIdDireccion(idAddress, idStatusFk).then(
          function (response) {
            if (response.status == 200) {
              ...
              $scope.ListDpto = [];
              inform.add(
                "No hay departamentos en esta direccion para ser asociados, contacte al area de soporte de TASS.",
                {
                  ttl: 5000,
                  type: "danger",
                },
     ...
     *                                                 *
     **************************************************/
    $scope.getCustomersListRs = {
      customerList: null,
      totalNumberOfCustomer: 0,
    };
    $scope.setCustomersListRs = {};
    $scope.getCustomerLisServiceFn = function (
      searchFilter,
      isNotCliente,
      idClientTypeFk,
      isInDebt,
      ...
      var searchFilter =
        searchFilter != undefined && searchFilter != "" && searchFilter != null
          ? searchFilter
          : null;
      var isNotCliente =
        isNotCliente != undefined && isNotCliente != null ? isNotCliente : "0";
      var idClientTypeFk =
        idClientTypeFk != undefined &&
        idClientTypeFk != "" &&
        idClientTypeFk != null
          ? idClientTypeFk
          : null;
      var isInDebt =
        isInDebt != false && isInDebt != undefined && isInDebt != null
          ? 1
          : null;
      var start =
        start != undefined && start != null && !isInDebt && !strict
          ? start
          : "";
      var limit =
        limit != undefined && limit != null && !isInDebt && !strict
          ? limit
          : "";
      var strict =
        strict != false && strict != undefined && strict != null
      ...
      return CustomerServices.getCustomerListLimit($scope.customersSearch).then(
        function (response) {
    ...
    $scope.loadCustomerFieldsFn = function (obj) {
      ...
      if (obj.idClientTypeFk == "1" || obj.idClientTypeFk == "3") {
        ...
        if (
          $scope.customerFound.idClientAdminFk != null &&
          $scope.customerFound.idClientAdminFk != undefined
        ) {
          var arrCompany = [];
          arrCompany = $scope.getCustomerBusinessNameByIdFn(
            $scope.customerFound.idClientAdminFk,
          );
          $timeout(function () {
          ...
          inform.add(
            "El Consorcio " +
              obj.name +
              " no se encuentra asociado a una Administración.",
            {
              ttl: 10000,
              type: "danger",
            },
        ...
        if (
          $scope.customerFound.idClientBranchFk != null &&
          $scope.customerFound.idClientBranchFk != undefined
        ) {
          var arrCompany = [];
          arrCompany = $scope.getCustomerBusinessNameByIdFn(
            $scope.customerFound.idClientBranchFk,
          );
    ...
    $scope.getLisOfCustomersByIdFn = function (obj) {
      ...
      $scope.listOffices = [];
      CustomerServices.getCustomersListByCustomerId(obj.idClient).then(
        function (response) {
          //console.log(response);
          if (response.status == 200) {
            ...
            $scope.listOffices = [];
            inform.add(
              "No hay Consorcios o Sucursales asociadas a la (" +
                obj.ClientType +
                ") - " +
                obj.name +
                " , contacte al area de soporte de BSS.",
              {
                ttl: 5000,
                type: "info",
              },
    ...
    $scope.filterStatusTicket = function (item) {
      ...
      if (
        $scope.changeStatusTicketSingle &&
        !$scope.changeStatusTicketMulti &&
        $scope.ticket.idStatusTicketKf != undefined
      ) {
        var opt = $scope.ticket.idStatusTicketKf;
      } else if (
        !$scope.changeStatusTicketSingle &&
        $scope.changeStatusTicketMulti &&
        $scope.filters.ticketStatus != undefined
      ) {
      ...
      switch (opt) {
        case "8":
          ...
          if (
            ...
            if (
              $scope.filters.typDelivery != undefined &&
              $scope.filters.typDelivery.idTypeDelivery == "1"
            ) {
              return item.idStatus == 7;
            } else {
              return item.idStatus == 4;
      ...
      userServices.updateUser($scope.update).then(function (response) {
        if (response.status == 200) {
          if ($scope.update.user.typeTenantChange) {
            console.log(
              "Usuario: " +
                $scope.update.user.fullNameUser +
            ...
            //OWNERS AND TENANTS
            if (
              ($scope.update.user.idProfileKf == 3 ||
                $scope.update.user.idProfileKf == 4 ||
                $scope.update.user.idProfileKf == 6) &&
              $scope.update.user.idTypeTenantKf == 1 &&
              $scope.update.user.idDeparment_Tmp
            ) {
              blockUI.start("Asociando usuario al departamento seleccionado.");
              $timeout(function () {
                $scope.depto.department.idUserKf = $scope.update.user.idUser;
                $scope.depto.department.idDepartment =
                  $scope.update.user.idDeparment_Tmp;
              }, 1500);
              ...
              $timeout(function () {
                ...
                $scope.approveDepto(
                  $scope.update.user.idTypeTenantKf,
                  $scope.depto.department.idDepartment,
                  1,
                );
              }, 2500);
              ...
              ($scope.update.user.idProfileKf == 4 ||
                $scope.update.user.idProfileKf == 5 ||
                $scope.update.user.idProfileKf == 6) &&
              $scope.update.user.idTypeTenantKf == 2 &&
              $scope.update.user.idDepartmentKf
            ) {
              ...
              $timeout(function () {
                ...
                $scope.approveDepto(
                  $scope.update.user.idTypeTenantKf,
                  $scope.depto.department.idUserKf,
                  1,
                );
              }, 2000);
              $timeout(function () {
          ...
          $timeout(function () {
            ...
            blockUI.message(
              "[Error]: " +
                response.status +
                ", Ha ocurrido un error en la comunicacion con el servidor.",
            );
            blockUI.stop();
          }, 1500);
        }
    ...
    $scope.findKeyByCodeFn = function (code, idClientKf) {
      return KeysServices.findKeyByCode(code, idClientKf).then(
        function (response) {
      ...
      switch (type) {
        ...
        case "1": //OWNER
          ...
          DepartmentsServices.approveOwnerDepto(id).then(function (response) {
            if (response.status == 200) {
              inform.add(
                "Departamento del propietario autorizado satisfactoriamente.",
                {
                  ttl: 5000,
                  type: "success",
                },
        ...
        case "2": //TENANT
          console.log("User: " + id);
          DepartmentsServices.approveTenantDepto(id, idStatus).then(
            function (response) {
              if (response.status == 200) {
                inform.add(
                  "Departamento del Habitante autorizado satisfactoriamente.",
                  {
                    ttl: 5000,
                    type: "success",
                  },
        ...
        case "6":
          if (
            (($scope.tkupdate.idMgmtMethodKf == "1" ||
              ...
              $scope.tkupdate.whereKeysAreEnable == "2" &&
              ($scope.tkupdate.isKeysEnable == "0" ||
                $scope.tkupdate.isKeysEnable == null)) ||
            (($scope.tkupdate.idMgmtMethodKf == "1" ||
              $scope.tkupdate.idMgmtMethodKf == "2") &&
              ($scope.tkupdate.whereKeysAreEnable == "1" ||
                $scope.tkupdate.whereKeysAreEnable == "2") &&
              $scope.tkupdate.isKeysEnable == "1")
          ) {
          ...
          if (
            ...
            $scope.tkupdate.isKeysEnable == "1" &&
            $scope.tkupdate.idMgmtMethodKf == "1" &&
            $scope.tkupdate.building.isStockInOffice == "1"
          ) {
    ...
    $scope.filterByStatusPanel = function (statusBy, opt) {
      ...
      $scope.filters = {
        ...
        isBillingInitiated: false,
        isTechnicianAssigned: false,
        isHasRefundsOpen: false,
        isInitialDeliveryActive: false,
        isHasStockInBuilding: false,
        mgmtKeyMethod: "",
        activationKeyMethod: "",
        isKeysEnable: "",
      };
      $scope.filters.ticketStatus = $scope.listStatusTicket.find(
        (s) => s.idStatus == statusBy,
      );
      switch (statusBy) {
        case "6":
          $scope.filters.paymentsType = $scope.paymentsType.find(
            (s) => s.id == 2,
          );
          $scope.monitor.filter.idTypePaymentKf =
            $scope.filters.paymentsType.id;
          $scope.filters.isHasRefundsOpen = opt;
          $scope.monitor.filter.isHasRefundsOpen = $scope.filters
            .isHasRefundsOpen
            ? 1
            : 0;
          break;
        case "8":
          ...
          $scope.monitor.filter.isInitialDeliveryActive = $scope.filters
            .isInitialDeliveryActive
            ? 1
            : 0;
          $scope.monitor.filter.isHasRefundsOpen = $scope.filters
            .isHasRefundsOpen
    ...
    $scope.monitor.filter = {
      ...
      dateDeliveredFrom: "",
      dateDeliveredTo: "",
      isBillingUploaded: null,
      isBillingInitiated: null,
      ...
      switch (opt) {
        case "dashboard":
          ...
          switch ($scope.sysLoggedUser.idProfileKf) {
            case "1":
              ...
              $scope.monitor.filter.idProfileKf =
                $scope.sysLoggedUser.idProfileKf;
            ...
            case "4":
              ...
              $scope.filters.topDH = "10";
              $scope.monitor.filter.idClientAdminFk =
                $scope.sysLoggedUser.company[0].idClient;
              $scope.monitor.filter.topfilter = $scope.filters.topDH;
              $scope.monitor.filter.idProfileKf =
                $scope.sysLoggedUser.idProfileKf;
              $scope.monitor.filter.idTypeTenantKf =
                $scope.sysLoggedUser.idTypeTenantKf;
              $scope.monitor.filter.idDepartmentKf =
                $scope.sysLoggedUser.idTypeTenantKf == "2"
                  ? $scope.sysLoggedUser.idDepartmentKf
                  : "";
            ...
            case "6":
              switch ($scope.sysLoggedUser.idTypeTenantKf) {
                case "1":
                  $scope.filters.topDH = "10";
                  $scope.getAddressByidTenantFn(
                    $scope.sysLoggedUser.idUser,
                    $scope.sysLoggedUser.idTypeTenantKf,
                    -1,
                  );
        ...
        case "search":
          switch ($scope.sysLoggedUser.idProfileKf) {
            case "1":
              $scope.monitor.filter.idClientAdminFk =
                $scope.filterCompanyKf.selected != undefined &&
                $scope.filterCompanyKf.selected.idClientTypeFk == "1"
                  ? $scope.filterCompanyKf.selected.idClient
                  : "";
              $scope.monitor.filter.idClientCompaniFk =
                $scope.filterCompanyKf.selected != undefined &&
                $scope.filterCompanyKf.selected.idClientTypeFk == "3"
                  ? $scope.filterCompanyKf.selected.idClient
                  : "";
              $scope.monitor.filter.idBuildingKf =
                $scope.filterAddressKf.selected != undefined &&
                $scope.filterCompanyKf.selected.idClientTypeFk == "1"
                  ? $scope.filterAddressKf.selected.idClient
                  : "";
              $scope.monitor.filter.idClientBranchFk =
                $scope.filterAddressKf.selected != undefined &&
                $scope.filterCompanyKf.selected.idClientTypeFk == "3"
                  ? $scope.filterAddressKf.selected.idClient
                  : "";
              ...
              $scope.monitor.filter.idProfileKf =
                $scope.sysLoggedUser.idProfileKf;
              $scope.monitor.filter.idTypeTicketKf = !$scope.filters.typeTicket
                ? ""
                : $scope.filters.typeTicket.idTypeTicket;
              $scope.monitor.filter.idStatusTicketKf = !$scope.filters
                .ticketStatus
                ? ""
                : $scope.filters.ticketStatus.idStatus;
              $scope.monitor.filter.idTypeDeliveryKf = !$scope.filters
                .typDelivery
                ? ""
                : $scope.filters.typDelivery.idTypeDelivery;
              $scope.monitor.filter.idTypePaymentKf =
                $scope.filters.paymentsType == "" ||
                $scope.filters.paymentsType == undefined
                  ? ""
                  : $scope.filters.paymentsType.id;
              $scope.monitor.filter.isInitialDeliveryActive = $scope.filters
                .isInitialDeliveryActive
                ? 1
                : 0;
              $scope.monitor.filter.isHasStockInBuilding = $scope.filters
                .isHasStockInBuilding
                ? 1
                : 0;
              $scope.monitor.filter.idMgmtMethodKf = $scope.filters
                .mgmtKeyMethod
                ? $scope.filters.mgmtKeyMethod
                : "";
              $scope.monitor.filter.whereKeysAreEnable = $scope.filters
                .activationKeyMethod
                ? $scope.filters.activationKeyMethod
                : "";
              $scope.monitor.filter.isKeysEnable = $scope.filters.isKeysEnable
                ? $scope.filters.isKeysEnable
                : "";
              $scope.monitor.filter.idTypeRequestFor = $scope.filters
                .filterCategoryKey
                ? $scope.filters.filterCategoryKey
                : "";
              $scope.monitor.filter.isBillingUploaded = $scope.filters
                .isBillingUploaded
                ? 1
                : 0;
              $scope.monitor.filter.isTechnicianAssigned = $scope.filters
                .isTechnicianAssigned
                ? 1
                : 0;
              ...
              if (
                // || ($scope.filters.paymentsType==undefined || $scope.filters.paymentsType==null || $scope.filters.paymentsType=='')
                ($scope.filters.paymentsType != undefined &&
                  $scope.filters.paymentsType != null &&
                  $scope.filters.paymentsType.id != "1" &&
                  $scope.filters.paymentsType.id != "2" &&
                  (!$scope.filters.isPaymentSucceeded ||
                    $scope.filters.isPaymentSucceeded)) ||
                ($scope.filters.paymentsType != undefined &&
                  $scope.filters.paymentsType != null &&
                  $scope.filters.paymentsType.id == "2" &&
                  $scope.filters.isPaymentSucceeded &&
                  $scope.filters.isBillingInitiated) ||
                ($scope.filters.paymentsType != undefined &&
                  $scope.filters.paymentsType != null &&
                  $scope.filters.paymentsType.id == "1" &&
                  $scope.filters.isBillingInitiated)
              ...
              if (
                $scope.filters.paymentsType != undefined &&
                $scope.filters.paymentsType != null &&
                $scope.filters.paymentsType.id != undefined &&
                $scope.filters.paymentsType.id == "2" &&
                (($scope.filters.ticketStatus != undefined &&
                  $scope.filters.ticketStatus.idStatus != "3" &&
                  $scope.filters.ticketStatus.idStatus != "6") ||
                  $scope.filters.ticketStatus == null) &&
                $scope.filters.isPaymentSucceeded
              ) {
              ...
              $scope.monitor.filter.isHasRefundsOpen = $scope.filters
                ...
                ? 1
                : 0;
              $scope.monitor.filter.idDeliveryCompanyKf = !$scope.filters
                .deliveryCompanyKf
                ? ""
                : $scope.filters.deliveryCompanyKf.idDeliveryCompany;
              //CREATED
              if (
                $scope.filters.dateCreatedFrom != null &&
                $scope.filters.dateCreatedFrom != undefined
              ) {
              ...
              if (
                $scope.filters.dateCreatedTo != null &&
                $scope.filters.dateCreatedTo != undefined
              ) {
              ...
              //DELIVERY
              if (
                $scope.filters.dateDeliveredFrom != null &&
                $scope.filters.dateDeliveredFrom != undefined
              ) {
              ...
              if (
                $scope.filters.dateDeliveredTo != null &&
                $scope.filters.dateDeliveredTo != undefined
              ) {
              ...
              $scope.monitor.filter.codTicket =
                $scope.filters.searchFilter != undefined &&
                $scope.filters.searchFilter != "" &&
                $scope.filters.searchFilter != null
                  ? $scope.filters.searchFilter
                  : null;
            ...
            case "4":
              ...
              $scope.monitor.filter.idTypeDeliveryKf = !$scope.filters
                ...
                ? ""
                : $scope.filters.typDelivery.idTypeDelivery;
              $scope.monitor.filter.idTypePaymentKf = !$scope.filters
                .paymentsType
                ? ""
                : $scope.filters.paymentsType.id;
              $scope.monitor.filter.dateCreatedFrom =
                $scope.filters.dateCreatedFrom;
              $scope.monitor.filter.dateCreatedTo =
                $scope.filters.dateCreatedTo;
                ...
                case "1":
                  ...
                  $scope.monitor.filter.idBuildingKf =
                    $scope.filterAddressKf.selected != undefined
                      ...
                      : "";
                  $scope.monitor.filter.topfilter = $scope.filters.topDH;
                  $scope.monitor.filter.idTypeTicketKf = !$scope.filters
                    .typeTicket
                    ? ""
                    : $scope.filters.typeTicket.idTypeTicket;
                  $scope.monitor.filter.idStatusTicketKf = !$scope.filters
        ...
        case "openTicket":
          try {
            ...
            $scope.functions = {
              isKeysEnable: false,
              whereKeysAreEnable: null,
              isTechnicianAssignedTmp: null,
            };
            $scope.rsNewKeychainList = [];
            $scope.list_new_keys = [];
            $scope.keys = { new: {} };
        ...
        case "ticket_refunds_complete":
          ...
          $scope.refund.ticket.history.push({
            idUserKf: $scope.sysLoggedUser.idUser,
            descripcion: null,
            idCambiosTicketKf: "26",
          });
          console.log($scope.refund);
          $("#changeModalStatus").modal("hide");
          $("#refundsModalDetails").modal({
            backdrop: "static",
            keyboard: false,
          });
          console.log($scope.refund);
        ...
        case "addNewKeyMulti":
          ...
          switch (obj.selected) {
            case true:
              let Depto =
                $scope.ticket.selected.idTypeRequestFor == "1"
                  ? $scope.tkupdate.department.floor +
                    "-" +
                    $scope.tkupdate.department.departament
                  : null;
              let idClientDepartament =
                $scope.tkupdate.department != undefined &&
                $scope.tkupdate.department.idClientDepartament != undefined
                  ? $scope.tkupdate.department.idClientDepartament
                  : null;
              if (
                $scope.rsNewKeychainList.length < $scope.tkupdate.keys.length
                ...
                if ($scope.rsNewKeychainList.length >= 1) {
                  for (var i = 0; i < $scope.rsNewKeychainList.length; i++) {
                    if ($scope.rsNewKeychainList[i].codigo == obj.codigo) {
                      inform.add(
                        "El Llavero con el Codigo: [" +
                          obj.codigo +
                          "], ya existe en en la nueva lista a asignar en el Departamento " +
                          Depto,
                        {
                          ttl: 15000,
                          type: "warning",
                ...
                if (!$scope.isCodeExist && !$scope.isCodeNewExist) {
                  ...
                  var idKeychainStatusKf =
                    $scope.ticket.idMgmtMethodKf == "1"
                      ? obj.idKeychainStatus
                      : 0;
                  var statusKey =
                    $scope.ticket.idMgmtMethodKf == "1" ? "Activo" : "Inactivo";
                  $scope.rsNewKeychainList.push({
                    idKeychain: obj.idKeychain,
                    idProductKf: obj.idProductKf,
                    descriptionProduct: obj.descriptionProduct,
                    categoryKeychain: "Departamento",
                    Depto: Depto,
                    codExt: obj.codExt,
                    codigo: obj.codigo,
                    idDepartmenKf: idClientDepartament,
                    idClientKf: obj.idClientKf,
                    idUserKf: null,
                    idCategoryKf: "1",
                ...
                for (var i = 0; i < $scope.tkupdate.keys.length; i++) {
                  ...
                  if ($scope.rsNewKeychainList[i]) {
                    ...
                    $scope.rsNewKeychainList[i].doors =
                      $scope.tkupdate.keys[i].doors;
                  }
                }
                if (
                  $scope.rsNewKeychainList.length == $scope.tkupdate.keys.length
                  ...
                  inform.add(
                    "Ya ha seleccionado la totalidad de los (" +
                      $scope.tkupdate.keys.length +
                      ") llaveros que fueron solicitados en el pedido.",
                    {
                      ttl: 15000,
                      type: "success",
                    },
                ...
                inform.add(
                  "Ya ha seleccionado los llaveros (" +
                    $scope.tkupdate.keys.length +
        ...
        case "addNewKeyManual":
          ...
          console.log(
            "$scope.rsNewKeychainList lenght: " +
              $scope.rsNewKeychainList.length,
          );
          console.log(
            "$scope.rsExistingKeyList lenght: " +
              $scope.rsExistingKeyList.length,
          );
          console.log(
            "$scope.tkupdate.keys lenght:     " + $scope.tkupdate.keys.length,
          );
          ...
          if (!$scope.tmpKey.new.autoComplete) {
            if ($scope.rsNewKeychainList.length < $scope.tkupdate.keys.length) {
              if ($scope.rsNewKeychainList.length >= 0) {
                if ($scope.rsNewKeychainList.length >= 1) {
                  for (var i = 0; i < $scope.rsNewKeychainList.length; i++) {
                    if (
                      $scope.rsNewKeychainList[i].codigo ==
                      $scope.tmpKey.new.codigo
                    ) {
                      if ($scope.ticket.selected.idTypeRequestFor == "1") {
                        inform.add(
                          "El Llavero con el Codigo: [" +
                            $scope.tmpKey.new.codigo +
                            "], ya existe en la nueva lista a asignar al Departamento " +
                            $scope.tmpKey.new.Depto,
                          {
                            ttl: 15000,
                            type: "warning",
                          },
                        ...
                        inform.add(
                          "El Llavero con el Codigo: [" +
                            $scope.tmpKey.new.codigo +
                            "], ya existe en la nueva lista a asignar al Edificio ",
                          {
                            ttl: 15000,
                            type: "warning",
                          },
                ...
                $scope
                  ...
                  .then(function (isCodeExistInBuilding) {
                    ...
                    switch (isCodeExistInBuilding) {
                      case 1:
                        ...
                        $scope.isCodeExist = true;
                        console.log(
                          "isCodeExistInBuilding: " + isCodeExistInBuilding,
                        );
                        break;
                      case 0:
                        $scope.isCodeExist = false;
                    ...
                    if (!$scope.isCodeExist && !$scope.isCodeNewExist) {
                      console.log("ADD_NO_EXIST");
                      let depto =
                        $scope.tmpKey.new.Depto != undefined
                          ? $scope.tmpKey.new.Depto
                          : null;
                      let idDepto =
                        $scope.tmpKey.new.department != undefined
                          ? $scope.tmpKey.new.department
                          : null;
                      ...
                      console.log(
                        "$scope.tmpKey.new.categoryKey      : " +
                          $scope.tmpKey.new.categoryKey,
                      );
                      console.log(
                        "$scope.tmpKey.new.categoryKeychain : " +
                          $scope.tmpKey.new.categoryKeychain,
                      );
                      console.log(
                        "$scope.tmpKey.new.codigoExt        : " +
                          $scope.tmpKey.new.codigoExt,
                      );
                      console.log(
                        "$scope.tmpKey.new.codigo           : " +
                      ...
                      $scope.rsNewKeychainList.push({
                        ...
                        Depto: depto,
                        codExt: $scope.tmpKey.new.codigoExt,
                        codigo: $scope.tmpKey.new.codigo,
                      ...
                      console.log($scope.rsNewKeychainList);
                      if (
                        $scope.ticket.keysMethodSelected != null &&
                        $scope.ticket.keysMethodSelected != undefined
                      ) {
                        for (var key in $scope.rsNewKeychainList) {
                          console.log($scope.rsNewKeychainList[key]);
                          if (
                            $scope.rsNewKeychainList[key].idKeychain ==
                            undefined
                          ) {
                        ...
                        console.info(
                          "$scope.thereIsKeyWithoutIdKeychain: " +
                            $scope.thereIsKeyWithoutIdKeychain,
                        );
                      }
                      obj.codigo = "";
              ...
              if (
                ...
                inform.add(
                  "Ya ha cargado la totalidad de los (" +
                    $scope.tkupdate.keys.length +
                    ") llaveros que fueron solicitados en el pedido.",
                  {
                    ttl: 15000,
              ...
              inform.add(
                "Ya ha cargado los (" +
                  $scope.tkupdate.keys.length +
                  ") llaveros solicitados en el pedido.",
                {
                  ttl: 15000,
                  type: "info",
                },
            ...
            console.log(
              "$scope.tmpKey.new.codigo: " + $scope.tmpKey.new.codigo,
            );
            console.log(
              "$scope.tmpKey.new.codigoExt: " + $scope.tmpKey.new.codigoExt,
            );
            ...
            if ($scope.rsNewKeychainList.length < $scope.tkupdate.keys.length) {
              if ($scope.rsNewKeychainList.length >= 0) {
                for (
                  var ai = 0;
                  ai <
                  $scope.tkupdate.keys.length - $scope.rsNewKeychainList.length;
                  ai++
                ) {
                  ...
                  $scope
                    .findKeyByCodeFn(newCode, $scope.tkupdate.building.idClient)
                    .then(function (isCodeExistInBuilding) {
                      console.log(isCodeExistInBuilding);
                      switch (isCodeExistInBuilding) {
                        case 1:
                      ...
                      if ($scope.isCodeNewExist) {
                        newCode = (
                          parseInt(newCode) + $scope.isCodeNewExistNumber
                        ).toString();
                        newCodeExt = (
                          parseInt(newCodeExt) + $scope.isCodeNewExistNumber
                        ).toString();
                        $scope.isCodeNewExist = false;
                        console.log(newCode);
                      ...
                      if (!$scope.isCodeExist && !$scope.isCodeNewExist) {
                        ...
                        console.log(
                          "$scope.tmpKey.new.codigoExt        : " + newCodeExt,
                        );
                        console.log(
                          "$scope.tmpKey.new.codigo           : " + newCode,
                        );
                        console.log(
                          "$scope.tkupdate.building.idClient  : " +
                            $scope.tkupdate.building.idClient,
                        ...
                        console.log($scope.rsNewKeychainList);
                        if (
                          $scope.ticket.keysMethod != null &&
                          $scope.ticket.keysMethod != undefined
                        ) {
                          for (var key in $scope.rsNewKeychainList) {
                            console.log($scope.rsNewKeychainList[key]);
                            if (
        ...
        case "removeNewKey":
          ...
          for (var existingKey in $scope.rsExistingKeyList) {
            if (
              $scope.rsExistingKeyList[existingKey].codigo == keySelected.codigo
            ) {
        ...
        case "cancelSetMgmtKeys":
          ...
          console.log(
            "$scope.existingStockKeys       : " +
              $scope.existingStockKeys.length,
          );
        ...
        case "deleteSingleFile":
          console.log(obj);
          blockUI.start(
            "Eliminando Factura del Pedido " + $scope.tkupdate.codTicket,
          );
          $timeout(function () {
        ...
        case "exportExcelList":
          if (obj.length == 0) {
            inform.add(
              "[INFO]: No hay pedidos en el estado seleccionado, para exportar. ",
              {
                ttl: 10000,
                type: "warning",
              },
            ...
            blockUI.start(
              "Generando Listado formato Excel de los pedidos en pantalla ",
            );
            $timeout(function () {
        ...
        case "keychainMulti":
          ...
          if (
            $scope.tkupdate.idMgmtMethodKf == null &&
            $scope.ticket.idMgmtMethodKf != undefined &&
            $scope.ticket.keysMethod.name != undefined
          ) {
            $scope.keys = { new: { products: { selected: {} } } };
            $scope.rsNewKeychainList = [];
            ...
            $scope.select = {
              ...
              keychainStatus: {},
              idTypeTicketKf: null,
              companies: { selected: undefined },
              address: { selected: undefined },
              products: { selected: undefined },
              products_reserva: { selected: undefined },
              products_cocheras: { selected: undefined },
            };
            var tk_selected = 0;
            $scope.isCodeExist = false;
            $scope.isCodeNewExist = false;
              ...
              case "6":
                ...
                for (var tkey in $scope.tkupdate.keys) {
                  for (var stock in $scope.rsAllKeychainListDataFiltered) {
                    if (
                      $scope.tkupdate.keys[tkey].idProduct ==
                        $scope.rsAllKeychainListDataFiltered[stock]
                          .idProductKf &&
                      tk_selected < $scope.tkupdate.keys.length
                    ) {
                      if ($scope.rsNewKeychainList.length >= 0) {
                        for (
                          var i = 0;
                          i < $scope.rsNewKeychainList.length;
                          i++
                        ) {
                          if (
                            $scope.rsNewKeychainList[i].codigo ==
                            $scope.rsAllKeychainListDataFiltered[stock].codigo
                          ) {
                            $scope.isCodeNewExist = true;
                            break;
                      ...
                      if (!$scope.isCodeExist && !$scope.isCodeNewExist) {
                        ...
                        $scope.rsNewKeychainList.push({
                          ...
                          Depto: Depto,
                          codExt:
                            $scope.rsAllKeychainListDataFiltered[stock].codExt,
                          codigo:
                            $scope.rsAllKeychainListDataFiltered[stock].codigo,
                          idDepartmenKf: idDepto,
                          idClientKf:
                        ...
                        $scope.rsAllKeychainListDataFiltered[stock].selected =
                          true;
                        tk_selected++;
                      }
                      for (var i = 0; i < $scope.tkupdate.keys.length; i++) {
                        ...
                        if ($scope.rsExistingKeyList[i]) {
                          // Set the doors property based on the index
                          $scope.rsExistingKeyList[i].doors =
                            $scope.tkupdate.keys[i].doors;
                          $scope.rsNewKeychainList[i].doors =
                            $scope.tkupdate.keys[i].doors;
                        }
        ...
        case "keychain_manual":
          ...
          $scope.keys.new.categoryKeychain =
            $scope.tkupdate.keys[0].categoryName;
          $scope.keys.new.products.selected = {
            idProduct: $scope.tkupdate.keys[0].idProduct,
            model: $scope.tkupdate.keys[0].model,
            classification: $scope.tkupdate.keys[0].classification,
            codigoFabric: $scope.tkupdate.keys[0].codigoFabric,
            descriptionProduct: $scope.tkupdate.keys[0].descriptionProduct,
            idProductClassification:
              $scope.tkupdate.keys[0].idProductClassification,
            brand: $scope.tkupdate.keys[0].brand,
            priceFabric: $scope.tkupdate.keys[0].priceFabric,
          };
          $scope.keys.new.department =
            $scope.tkupdate.idTypeRequestFor == "1"
              ? $scope.tkupdate.department.idClientDepartament
              : null;
          $scope.keys.new.Depto =
            $scope.tkupdate.idTypeRequestFor == "1"
              ? $scope.tkupdate.department.floor +
                "-" +
                $scope.tkupdate.department.departament
          ...
          console.log($scope.keys.new.Depto);
          var tk_selected = 0;
          $scope.isCodeExist = false;
          $scope.isCodeNewExist = false;
          var Depto = null;
        ...
        case "setMgmtKeys":
          ...
          console.info(
            "Internet: " +
              (obj.building.isHasInternetOnline === null ? "No" : "Si"),
          );
            ...
            case "1": //STOCK
              ...
              switch ($scope.ticket.selected.idTypeRequestFor) {
                ...
                case "6":
                  ...
                  switch (obj.idTypeDeliveryKf) {
                    case "1": //RETIRO EN OFICINA
                      $scope.tkupdate.mess2show =
                        'El Pedido pasara a "Listo para Retirar", por favor,     Confirmar?';
                      //$scope.tkupdate.idDeliveryCompanyKf=null;
                      console.log(obj);
                      break;
                    case "2": //RENTREGA EN DOMICILIO
                      $scope.functions.whereKeysAreEnable =
                        obj.building.isHasInternetOnline === null ? "2" : "1";
                      if (
                        obj.building.isStockInOffice == "1" ||
                        obj.building.isStockInBuilding == "1"
                      ) {
                        $scope.tkupdate.mess2show =
                          'El Pedido pasara a "Pendiente de entrega", por favor,     Confirmar?';
                      }
                ...
                case "4":
                  ...
                  $scope.functions.isKeysEnable = "1";
                  $scope.tkupdate.mess2show =
                    'El Pedido sera "Completado", una vez asginado el llavero, por favor,     Confirmar?';
                  break;
              }
              break;
            case "2": //MANUAL
              ...
              switch ($scope.ticket.selected.idTypeRequestFor) {
                ...
                case "6":
                  ...
                  switch (obj.idTypeDeliveryKf) {
                    case "1": //RETIRO EN OFICINA
                      if (
                        obj.building.isHasInternetOnline === null ||
                        obj.building.isHasInternetOnline != null
                      ) {
                        //NO INTERNET OR WITH INTERNET
                        $scope.tkupdate.mess2show =
                          'El Pedido quedara "En Preparación" pendiente de Habilitación/Activación de Llaveros, por favor, Confirmar?';
                      }
                      console.log(obj);
                      break;
        ...
        case "applySetMgmtKeys":
          ...
          switch ($scope.tkupdate.idMgmtMethodKf) {
            case "1":
              $scope.tkupdate.history.push({
                idUserKf: $scope.sysLoggedUser.idUser,
                descripcion: null,
                idCambiosTicketKf: "29",
              });
              $scope.tkupdate.history.push({
                idUserKf: $scope.sysLoggedUser.idUser,
                descripcion: null,
                idCambiosTicketKf: "30",
              });
              $scope.tkupdate.history.push({
                idUserKf: $scope.sysLoggedUser.idUser,
                descripcion: null,
                idCambiosTicketKf: "40",
              });
              $scope.tkupdate.history.push({
                idUserKf: $scope.sysLoggedUser.idUser,
                descripcion: null,
                idCambiosTicketKf: "31",
              });
            ...
            case "2":
              ...
              $scope.tkupdate.history.push({
                idUserKf: $scope.sysLoggedUser.idUser,
                descripcion: null,
                idCambiosTicketKf: "45",
              });
              $scope.tkupdate.history.push({
                idUserKf: $scope.sysLoggedUser.idUser,
                descripcion: null,
                idCambiosTicketKf: "39",
              });
              $scope.tkupdate.history.push({
                idUserKf: $scope.sysLoggedUser.idUser,
                descripcion: null,
          ...
          angular.forEach($scope.rsNewKeychainList, function (key, i) {
            ...
            $timeout(function () {
              ...
              var keys = {
                idKeychain:
                  key.idKeychain != undefined && key.idKeychain != null
                    ? key.idKeychain
                    : null,
                idKeychainKf:
                  key.idKeychain != undefined && key.idKeychain != null
                ...
                idClientAdminKf:
                  key.idClientAdminKf != "" &&
                  key.idClientAdminKf != null &&
                  key.idClientAdminKf != undefined
                    ? key.idClientAdminKf
                    : null,
        ...
        case "apply_isKeysEnable":
          ...
          if (
            ...
            $scope.tkupdate.whereKeysAreEnable =
              $scope.ticket.whereKeysAreEnableTmp != null
                ? $scope.ticket.whereKeysAreEnableTmp
                : null;
        ...
        case "ticket_manual_payment":
          ...
          $scope.getCostByCustomer.rate.deviceIsOnline =
            obj.building.isHasInternetOnline ||
            obj.building.isHasInternetOnline == null ||
            obj.building.isHasInternetOnline == undefined
              ? "2"
              : "1";
        ...
        case "ticket_manual_payment_add":
          ...
          $scope.mp.payment.data.external_reference =
            obj.idManualPayment != "3"
              ? obj.selected.idTicket + "_" + obj.manualPaymentNumber
              : obj.selected.idTicket + "_" + dateTimeString;
          ...
          $scope.mp.payment.data.manualPaymentDescription =
            obj.manualPaymentDescription;
          ...
          $scope.mp.payment.data.mp_payment_type =
            obj.idManualPayment != "3" ? "wire transfer" : "deposit";
          ...
          console.log($scope.mp.payment.data);
          ticketServices
            .addPayment($scope.mp.payment)
            .then(function (response) {
              console.log(response);
              if (response.status == 200) {
                console.log("Solicitud de Pago registrada satisfactoriamente");
                inform.add(
                  "La solicitud de pago ha sido registrada Satisfactoriamente. ",
                  {
                    ttl: 5000,
                    type: "success",
                  },
                ...
                $scope.update.ticket.history.push({
                  idUserKf: $scope.sysLoggedUser.idUser,
                  descripcion: "El pago ha sido registro de forma manual",
                  idCambiosTicketKf: "4",
                });
                $scope.update.ticket.history.push({
                  idUserKf: $scope.sysLoggedUser.idUser,
                  descripcion: null,
                  idCambiosTicketKf: "13",
                });
                console.log($scope.update);
                $timeout(function () {
                ...
                console.log(
                  "Payment request has failed, contact administrator",
                );
                inform.add("Error: [500] Contacta al area de soporte. ", {
                  ttl: 5000,
                  type: "danger",
        ...
        case "ticket_delivery_change":
          ...
          if (
            $scope.keysTotalPrice >= keyTotalAllowed ||
            ($scope.ticket.building != undefined &&
              $scope.ticket.building.isInitialDeliveryActive.length == 1 &&
              $scope.ticket.building.isInitialDeliveryActive[0]
                .expiration_state != undefined &&
              !$scope.ticket.building.isInitialDeliveryActive[0]
                .expiration_state) ||
            $scope.ticket.building.isStockInBuilding == "1"
          ) {
        ...
        case "apply_ticket_delivery_change":
          ...
          if (
            num(obj.selected.idTypeDeliveryKf) ===
              num(obj.delivery.idTypeDeliveryKf) &&
            num(obj.selected.idDeliveryTo) === num(obj.delivery.idDeliveryTo) &&
            num(obj.delivery.whoPickUp.idUser) ===
              num(obj.selected.idUserDelivery) &&
            num(obj.cost.delivery) === num(obj.selected.costDelivery)
          ) {
            inform.add(
              "No hay cambio en su metodo de envío, intente nuevamente.",
              {
                ttl: 5000,
                type: "info",
              },
            ...
            $scope.costDelivery =
              obj.selected.costDelivery != null
                ? Number(obj.selected.costDelivery)
                : null;
            ...
            switch (obj.selected.idTypePaymentKf) {
              case "1":
                if (
                  obj.selected.idTypeDeliveryKf !=
                    obj.delivery.idTypeDeliveryKf &&
                  obj.delivery.idTypeDeliveryKf == "1"
                ) {
                  $scope.update.ticket.history.push({
                    idUserKf: $scope.sysLoggedUser.idUser,
                    descripcion: null,
                    idCambiosTicketKf: "12",
                  });
                  $scope.update.ticket.history.push({
                    idUserKf: "1",
                    descripcion: null,
                    idCambiosTicketKf: "16",
                  });
                  inform.add(
                    "Cobro de ($ " +
                      obj.selected.costDelivery +
                      ") por envío del pedido " +
                      obj.codTicket +
                      " no sera realizado, BSS Seguridad.",
                    {
                      ttl: 12000,
                      type: "info",
                    },
                  ...
                  obj.selected.idTypeDeliveryKf !=
                    obj.delivery.idTypeDeliveryKf &&
                  obj.delivery.idTypeDeliveryKf == "2"
                ) {
                  $scope.update.ticket.history.push({
                    idUserKf: $scope.sysLoggedUser.idUser,
                    descripcion: null,
                  ...
                  $scope.update.ticket.history.push({
                    idUserKf: "1",
                    descripcion: null,
                    idCambiosTicketKf: "17",
                  });
                  inform.add(
                    "Se adicionaran ($ " +
                      obj.cost.delivery +
                      "), por concepto de envío, al costo total de su pedido, BSS Seguridad.",
                    {
                      ttl: 6000,
                      type: "warning",
                    },
                  ...
                  obj.selected.idTypeDeliveryKf ==
                    obj.delivery.idTypeDeliveryKf &&
                  obj.selected.idDeliveryTo != obj.delivery.idDeliveryTo &&
                  obj.cost.delivery != undefined &&
                  obj.cost.delivery != null &&
                  ($scope.costDelivery == null || $scope.costDelivery == 0) &&
                  obj.cost.delivery > 0
                ) {
                  $scope.update.ticket.history.push({
                    idUserKf: $scope.sysLoggedUser.idUser,
                  ...
                  obj.cost.delivery != undefined &&
                  obj.cost.delivery != null &&
                  $scope.costDelivery != null &&
                  $scope.costDelivery > 0 &&
                  obj.cost.delivery > 0 &&
                  obj.cost.delivery > $scope.costDelivery
                ) {
                  $scope.update.ticket.history.push({
                    idUserKf: $scope.sysLoggedUser.idUser,
                    descripcion: null,
                  ...
                  $scope.subTotalDeliveryCharged =
                    Number(obj.cost.delivery) - Number($scope.costDelivery);
                  $scope.subTotalDelivery = Number(obj.cost.delivery);
                  inform.add(
                    "Se adicionaran ($ " +
                      $scope.subTotalDeliveryCharged +
                      ") de diferencia, por concepto de envío, al costo total de su pedido, BSS Seguridad.",
                    {
                      ttl: 6000,
                      type: "warning",
                    },
                  ...
                  $scope.subTotalDelivery = 0;
                  $scope.subTotalDelivery = Number(obj.cost.delivery);
                  $scope.subTotalRefunDelivery =
                    Number($scope.costDelivery) - Number(obj.cost.delivery);
                  inform.add(
                    "El pedido " +
                      obj.codTicket +
                      " tendra un descuento de ($ " +
                      $scope.subTotalRefunDelivery +
                      ") por envío, BSS Seguridad.",
                    {
                      ttl: 12000,
                      type: "info",
                    },
                  ...
                  obj.selected.idTypeDeliveryKf ==
                    obj.delivery.idTypeDeliveryKf &&
                  obj.selected.idDeliveryTo == obj.delivery.idDeliveryTo &&
                  obj.cost.delivery == obj.selected.costDelivery
                ) {
                  $scope.update.ticket.history.push({
                    idUserKf: $scope.sysLoggedUser.idUser,
                    descripcion: null,
                  ...
                  inform.add(
                    "No se registran costos adicionales, por concepto de envío, al costo total de su pedido, BSS Seguridad.",
                    {
                      ttl: 6000,
                      type: "info",
                    },
                  ...
                  inform.add(
                    "El pedido no tendra una recarga extra por envío al nuevo domicilio seleccionado, BSS Seguridad.",
                    {
                      ttl: 6000,
                      type: "success",
                    },
              ...
              case "2":
                if (
                  ...
                  if (
                    obj.selected.paymentDetails != undefined &&
                    obj.selected.paymentDetails != null &&
                    obj.selected.paymentDetails.mp_collection_status ==
                      "approved" &&
                    obj.selected.paymentDetails.mp_status_detail == "accredited"
                  ) {
                    $scope.update.ticket.refund = [];
                    $scope.update.ticket.refund.push({
                      idTicketKf: obj.selected.idTicket,
                      idRefundTypeKf: "1",
                      description: "",
                      refundAmount: obj.selected.costDelivery,
                    });
                    ...
                    $scope.update.ticket.history.push({
                      idUserKf: "1",
                      descripcion: null,
                      idCambiosTicketKf: "15",
                    });
                    inform.add(
                      "Se realizara un reintegro de ($ " +
                        obj.selected.costDelivery +
                        "), del costo inicial de su pedido, BSS Seguridad.",
                      {
                        ttl: 6000,
                        type: "info",
                      },
                    ...
                    if (
                      ...
                      inform.add(
                        "Nuevo link de pago sera generado para el pago de su pedido, BSS Seguridad.",
                        {
                          ttl: 6000,
                          type: "warning",
                        },
                  ...
                  if (
                    ...
                    if (
                      ...
                      inform.add(
                        "Nuevo link de pago por el monto de ($ " +
                          obj.cost.delivery +
                          "), sera generado por concepto de envío de su pedido, BSS Seguridad.",
                        {
                          ttl: 6000,
                          type: "warning",
                        },
                    ...
                    inform.add(
                      "Se adicionara el monto de ($ " +
                        obj.cost.delivery +
                        "), por concepto de envío de su pedido, BSS Seguridad.",
                      {
                        ttl: 6000,
                        type: "warning",
                      },
                  ...
                  if (
                    ...
                    inform.add(
                      "Se descontara un total de ($ " +
                        $scope.subTotalRefunDelivery +
                        "), por diferencia de envío de su pedido, BSS Seguridad.",
                      {
                        ttl: 6000,
                        type: "warning",
                      },
            ...
            if (
              obj.selected.idTypeRequestFor != "2" &&
              obj.selected.idTypeRequestFor != "4"
            ) {
              if (obj.delivery.idTypeDeliveryKf == "1") {
                ...
                $scope.otherDeliveryAddress.id =
                  obj.selected.otherDeliveryAddress != undefined &&
                  obj.selected.otherDeliveryAddress != null
                    ? obj.selected.otherDeliveryAddress.id
                    : null;
                $scope.update.ticket.otherDeliveryAddress = {
                  id: $scope.otherDeliveryAddress.id,
                  address: null,
                  number: null,
                  floor: null,
                  idProvinceFk: null,
                ...
                if (obj.delivery.whoPickUp.id == undefined) {
                  ...
                  $scope.thirdPersonDelivery.id =
                    obj.selected.thirdPersonDelivery != undefined &&
                    obj.selected.thirdPersonDelivery != null
                      ? obj.selected.thirdPersonDelivery.id
                      : null;
                  $scope.update.ticket.idUserDelivery =
                    obj.delivery.deliveryTo.idUser;
                  $scope.update.ticket.thirdPersonDelivery = {
                    id: $scope.thirdPersonDelivery.id,
                    fullName: null,
                    movilPhone: null,
                    address: null,
                    number: null,
                  ...
                  $scope.update.ticket.thirdPersonDelivery = {
                    id: $scope.thirdPersonDelivery.id,
                    fullName: obj.delivery.thirdPerson.fullNameUser,
                    movilPhone: obj.delivery.thirdPerson.movilPhone,
                    dni: obj.delivery.thirdPerson.dni,
                    address: null,
                    number: null,
                    floor: null,
                    idProvinceFk: null,
                ...
                if (
                  obj.delivery.whoPickUp.id == undefined &&
                  obj.delivery.idDeliveryTo == 1
                ) {
                  $scope.update.ticket.idWhoPickUp = "1";
                  $scope.otherDeliveryAddress.id =
                    obj.selected.otherDeliveryAddress != undefined &&
                  ...
                  $scope.update.ticket.idUserDelivery =
                    obj.delivery.deliveryTo.idUser;
                  $scope.update.ticket.idDeliveryAddress =
                    obj.building.idClient;
                } else if (
                  obj.delivery.whoPickUp.id == undefined &&
                  obj.delivery.idDeliveryTo == 2
                ) {
                  $scope.update.ticket.idWhoPickUp = 1;
                  $scope.otherDeliveryAddress.id =
                    obj.selected.otherDeliveryAddress != undefined &&
                  ...
                  $scope.update.ticket.otherDeliveryAddress = {
                    id: $scope.otherDeliveryAddress.id,
                    address: obj.delivery.otherAddress.streetName,
                    number: obj.delivery.otherAddress.streetNumber,
                    floor:
                      obj.delivery.otherAddress.floor +
                      "-" +
                      obj.delivery.otherAddress.department,
                    idProvinceFk:
                      obj.delivery.otherAddress.province.selected.idProvince,
                    idLocationFk:
                      obj.delivery.otherAddress.location.selected.idLocation,
                  };
                  $scope.update.ticket.thirdPersonDelivery = {
                    id: $scope.thirdPersonDelivery.id,
                    fullName: null,
                  ...
                  obj.delivery.whoPickUp.id == 2 &&
                  obj.delivery.idDeliveryTo == null
                ) {
                  $scope.update.ticket.idWhoPickUp = obj.delivery.whoPickUp.id;
                  $scope.otherDeliveryAddress.id =
                    obj.selected.otherDeliveryAddress != undefined &&
                  ...
                  $scope.update.ticket.thirdPersonDelivery = {
                    ...
                    movilPhone: obj.delivery.thirdPerson.movilPhone,
                    dni: obj.delivery.thirdPerson.dni,
                    address: obj.delivery.thirdPerson.streetName,
                    number: obj.delivery.thirdPerson.streetNumber,
                    floor:
                      obj.delivery.thirdPerson.floor +
                      "-" +
                      obj.delivery.thirdPerson.department,
                    idProvinceFk:
                      obj.delivery.thirdPerson.province.selected.idProvince,
                    idLocationFk:
                      obj.delivery.thirdPerson.location.selected.idLocation,
                  };
                  $scope.update.ticket.otherDeliveryAddress = {
                    id: $scope.otherDeliveryAddress.id,
                    address: null,
            ...
            $scope.update.ticket.idTypeRequestFor =
              obj.selected.idTypeRequestFor;
            ...
            $scope.update.ticket.idTypeDeliveryKf =
              obj.delivery.idTypeDeliveryKf;
            ...
            $scope.update.ticket.whereKeysAreEnable =
              obj.selected.whereKeysAreEnable;
            ...
            subTotalCosts =
              NaN2Zero(Number(subTotalService)) +
              NaN2Zero(Number(subTotalKeys)) +
              NaN2Zero(Number($scope.subTotalDelivery));
            $scope.update.ticket.total = subTotalCosts.toFixed(2);
            $scope.update.ticket.idPaymentDeliveryKf =
              obj.selected.idPaymentDeliveryKf != null
                ? obj.selected.idPaymentDeliveryKf
                : null;
        ...
        case "ticket_precheck_cancel":
          ...
          for (var key in obj.keys) {
            if (
              obj.keys[key].keychain != null &&
              obj.keys[key].keychain != undefined
            ) {
              keyAssigned++;
            }
          }
        ...
        case "ticket_request_cancel":
          console.log(obj);
          $scope.data = {
            ticket: { idTicket: null, codTicket: "", history: [] },
          };
          ...
          $scope.data.ticket.history.push({
            idUserKf: $scope.sysLoggedUser.idUser,
            idTicketKf: obj.idTicket,
            descripcion: null,
            idCambiosTicketKf: "8",
          });
          $timeout(function () {
        ...
        case "approve_ticket_request_cancel":
          ...
          switch (obj.idTypePaymentKf) {
            ...
            case "2": //MercadoPago
              if (obj.idTypeDeliveryKf != null) {
                if (
                  obj.paymentDetails != undefined &&
                  obj.paymentDetails != null &&
                  obj.paymentDetails.mp_collection_status == "approved" &&
                  obj.paymentDetails.mp_status_detail == "accredited"
                ) {
                  $scope.update.ticket.refund = [];
                  $scope.update.ticket.isHasRefundsOpen = 1;
                  if (
                    obj.paymentDeliveryDetails != undefined &&
                    obj.paymentDeliveryDetails != null &&
                    obj.isDeliveryHasChanged == "1" &&
                    obj.paymentDeliveryDetails.mp_collection_status ==
                      "approved" &&
                    obj.paymentDeliveryDetails.mp_status_detail == "accredited"
                  ) {
                    $scope.subTotalTotal = Number(obj.total);
                    $scope.update.ticket.refund.push({
                      idTicketKf: obj.idTicket,
                      idRefundTypeKf: "1",
                      description: "",
                      refundAmount: $scope.subTotalTotal,
                    });
                    $scope.update.ticket.history.push({
                      idUserKf: $scope.sysLoggedUser.idUser,
                      descripcion: null,
                      idCambiosTicketKf: "24",
                    });
                    inform.add(
                      "Se realizara un reintegro de ($ " +
                        $scope.subTotalTotal +
                    ...
                    $scope.subTotalTotal =
                      Number(obj.total) - Number(obj.costDelivery);
                    $scope.update.ticket.refund.push({
                      idTicketKf: obj.idTicket,
                      idRefundTypeKf: "1",
                      description: "",
              ...
              angular.forEach(obj.keys, function (key, i) {
                ...
                $timeout(function () {
                  ...
                  if (
                    obj.isKeysEnable == "1" &&
                    key.keychain != null &&
                    key.keychain != undefined &&
                    (obj.building.isStockInBuilding ||
                      obj.building.isStockInOffice)
                  ) {
                    console.log("Llavero a Actualizar: " + keys.codigo);
                    $scope.updateKeyFn({ llavero: keys });
                  } else {
          ...
          if (obj.idTypeDeliveryKf == "2") {
            if (obj.idStatusTicketKf != "5") {
              ...
              if ($scope.ticket.delivery_schedule_at != null) {
                $scope.ticket.deliveryDate = $scope.formatDate(
                  $scope.ticket.delivery_schedule_at,
                );
              } else {
                $scope.ticket.deliveryDate = new Date();
              }
            ...
            if ($scope.ticket.idWhoPickUp == "1") {
              ...
              $scope.ticket.fullname =
                $scope.ticket.thirdPersonDelivery.fullName;
            }
          }
        ...
        case "apply_change_ticket_status_single":
          ...
          $scope.update.ticket.idTypeDeliveryKf = obj.idTypeDeliveryKf;
          if (
            obj.newTicketStatus.idStatus == "1" &&
            obj.idTypeDeliveryKf == "1" &&
            obj.idWhoPickUp == "1"
          ) {
            $scope.update.ticket.retiredByDNI = obj.userDelivery.dni;
            $scope.update.ticket.retiredByFullName =
              obj.userDelivery.fullNameUser;
          } else if (
            obj.newTicketStatus.idStatus == "1" &&
            obj.idTypeDeliveryKf == "1" &&
            obj.idWhoPickUp == "3"
            ...
            $scope.update.ticket.retiredByFullName =
              obj.thirdPersonDelivery.fullName;
          } else {
          ...
          $scope.update.ticket.delivery_schedule_at =
            obj.newTicketStatus.idStatus == "5" &&
            obj.idTypeDeliveryKf == "2" &&
            obj.deliveryDate != undefined
              ? obj.deliveryDate
              : null;
          $scope.update.ticket.delivered_at =
            obj.newTicketStatus.idStatus == "1" && obj.deliveryDate != undefined
              ? obj.deliveryDate
              : null;
          $scope.update.ticket.idDeliveryCompanyKf =
            obj.newTicketStatus.idStatus == "5" &&
        ...
        case "setInTransitStatus":
          ...
          if (obj.idTypeDeliveryKf == "2") {
            if (obj.idStatusTicketKf != "5") {
              $scope.ticket.deliveryDate = new Date();
              $scope.ticket.newTicketStatus =
                $scope.listStatusTicketChange.find((s) => s.idStatus == "5");
            } else {
              if ($scope.ticket.delivery_schedule_at != null) {
                $scope.ticket.deliveryDate = $scope.formatDate(
                  $scope.ticket.delivery_schedule_at,
        ...
        case "applyInTransitStatus":
          ...
          $scope.update.ticket.delivery_schedule_at =
            ...
            obj.idTypeDeliveryKf == "2" &&
            obj.deliveryDate != undefined
              ? formatDateForDB(obj.deliveryDate)
              : null;
          $scope.update.ticket.delivered_at = null;
          $scope.update.ticket.idDeliveryCompanyKf =
            $scope.tkupdate.idDeliveryCompanyKf;
          ...
          if ($scope.selectedTicketList.length >= 1) {
            ...
            if (obj[0].idTypeDeliveryKf == "2") {
              ...
              if ($scope.ticket.idWhoPickUp == "1") {
                $scope.ticket.dni = $scope.ticket.userDelivery.dni;
                $scope.ticket.fullname =
                  $scope.ticket.userDelivery.fullNameUser;
              } else if ($scope.ticket.idWhoPickUp == "3") {
                $scope.ticket.dni = $scope.ticket.thirdPersonDelivery.dni;
                $scope.ticket.fullname =
                  $scope.ticket.thirdPersonDelivery.fullName;
            ...
            inform.add(
              "Han sido seleccionados  (" +
                $scope.selectedTicketList.length +
                ") pedidos para el cambio de estatus, BSS Seguridad.",
              {
                ttl: 6000,
                type: "info",
              },
            ...
            inform.add(
              "No han sido seleccionados pedidos para el cambio de estatus, BSS Seguridad.",
              {
                ttl: 6000,
                type: "info",
              },
        ...
        case "apply_change_ticket_status_multi":
          ...
          angular.forEach(obj, function (ticket) {
            ...
            $timeout(function () {
              ...
              $scope.update.ticket.retiredByDNI =
                $scope.ticket.newTicketStatus.idStatus == "1" &&
                ticket.idTypeDeliveryKf == "1"
                  ? ticket.dni
                  : null;
              $scope.update.ticket.retiredByFullName =
                $scope.ticket.newTicketStatus.idStatus == "1" &&
                ticket.idTypeDeliveryKf == "1"
                  ...
                  : null;
              $scope.update.ticket.idNewStatusKf =
                $scope.ticket.newTicketStatus.idStatus;
              $scope.update.ticket.delivery_schedule_at =
                $scope.ticket.newTicketStatus.idStatus == "5" &&
                ticket.idTypeDeliveryKf == "2" &&
                $scope.ticket.deliveryDate != undefined
                  ? $scope.ticket.deliveryDate
                  : null;
              $scope.update.ticket.delivered_at =
                $scope.ticket.newTicketStatus.idStatus == "1" &&
                $scope.ticket.deliveryDate != undefined
                  ...
                  : null;
              $scope.update.ticket.idDeliveryCompanyKf =
                ($scope.ticket.idDeliveryCompanyKf == null ||
                  $scope.ticket.idDeliveryCompanyKf == undefined) &&
                $scope.ticket.deliveryDate
                  ? ticket.idDeliveryCompanyKf
                  : $scope.ticket.idDeliveryCompanyKf;
          ...
          $q.all(assignedtickets).then(function () {
            inform.add(
              "Los pedidos seleccionados ahora se encuentran en " +
                $scope.ticket.newTicketStatus.statusName +
                ", BSS Seguridad.",
              {
                ttl: 6000,
                type: "info",
        ...
        case "approveTicket":
          ...
          if (
            (($scope.sysLoggedUser.idProfileKf == 1 ||
              $scope.sysLoggedUser.idProfileKf == 4) &&
              obj.department.isAprobatedAdmin != 1 &&
              obj.department.idUserKf == obj.userRequestBy.idUser &&
              (obj.userRequestBy.idProfileKf == "3" ||
                obj.userRequestBy.idProfileKf == "4" ||
                obj.userRequestBy.idProfileKf == "6") &&
              obj.userRequestBy.idTypeTenantKf == "1") ||
            (($scope.sysLoggedUser.idProfileKf == 1 ||
              $scope.sysLoggedUser.idProfileKf == 4) &&
              obj.userRequestBy.isDepartmentApproved == null &&
              (obj.userRequestBy.idProfileKf == "4" ||
                obj.userRequestBy.idProfileKf == "5" ||
                obj.userRequestBy.idProfileKf == "6") &&
              obj.userRequestBy.idTypeTenantKf == "2")
          ) {
        ...
        case "approveDepto":
          ...
          if (obj.userRequestBy.idTypeTenantKf == "1") {
            ...
            $scope.depto = {
              department: { idDepartment: null, idUserKf: null },
            };
            //OWNER
            blockUI.start("Asociando usuario al departamento seleccionado.");
            $timeout(function () {
              ...
              $scope.depto.department.idDepartment =
                obj.department.idClientDepartament;
            }, 1500);
            $timeout(function () {
              blockUI.message("Asignando departamento del usuario.");
              $scope.fnAssignDepto($scope.depto);
            ...
            $scope.update.user = {
              ...
              phoneLocalNumberUser: null,
              idAddresKf: null,
              idProfileKf: null,
              idTypeTenantKf: null,
              idCompanyKf: null,
              idTyepeAttendantKf: null,
              descOther: null,
              idDepartmentKf2: null,
              isEdit: null,
              requireAuthentication: null,
              dni: null,
              idSysProfileFk: null,
              isCreateByAdmin: null,
              typeTenantChange: false,
            };
            $scope.depto = {
              department: { idDepartment: null, idUserKf: null },
            };
        ...
        case "setWhoPickUpList":
          ...
          if (obj.idTypeRequestFor == "1") {
            if (
              obj.userMadeBy != undefined &&
              obj.userMadeBy.idUser != obj.userRequestBy.idUser
            ) {
          ...
          $scope.whoPickUpList.push({
            id: 2,
            fullNameUser: "Encargado",
            type: "Otros",
          });
          $scope.whoPickUpList.push({
            id: 3,
            fullNameUser: "Tercera Persona",
            type: "Otros",
          });
        ...
        case "checkWhoPickUp":
          console.log(obj);
          if (
            $scope.ticket.selected.paymentDetails != undefined &&
            $scope.ticket.selected.paymentDetails != null &&
            $scope.ticket.selected.paymentDetails.mp_collection_status ==
              null &&
            $scope.ticket.selected.paymentDetails.mp_status_detail == null
          ) {
            inform.add(
              "Recuerde que puede haber costos adicionales deacuerdo al metodo de envío seleccionado.",
              {
                ttl: 5000,
                type: "info",
              },
          ...
          if (obj.whoPickUp != undefined) {
            ...
            if (obj.whoPickUp.id == "3") {
              ...
              if (
                ...
                $scope.ticket.delivery.thirdPerson != undefined
              ) {
                inform.add(
                  "Completar todos datos de la tercera persona:  " +
                    $scope.ticket.delivery.thirdPerson.fullNameUser +
                    " para continuar.",
                  {
                    ttl: 5000,
                    type: "warning",
                ...
                if (
                  ...
                  $scope.ticket.delivery.thirdPerson.streetName = street
                    .trim()
                    .toString();
                  $scope.ticket.delivery.thirdPerson.streetNumber = number
                    .trim()
                    .toString();
                  $scope.ticket.delivery.thirdPerson.province = {
                    selected: {
                      idProvince: $scope.ticket.building.idProvince,
                      province: $scope.ticket.building.province,
                      idProvinceAPIGobFk:
                        $scope.ticket.building.idProvinceAPIGobFk,
                    },
                  };
                  $scope.ticket.delivery.thirdPerson.location = {
                    selected: {
                      idLocation: $scope.ticket.building.idLocation,
                      location: $scope.ticket.building.location,
                      idProvinceFK: $scope.ticket.building.idProvinceFK,
                    },
                  };
                }
              ...
              $scope.ticket.delivery.idDeliveryTo = null;
              $scope.ticket.delivery.otherAddress = null;
              $("#deliveryAttendantList").modal({
                backdrop: "static",
                keyboard: true,
              });
            } else if (
              obj.whoPickUp.id == undefined &&
              $scope.ticket.delivery.idTypeDeliveryKf == 2 &&
              (obj.idDeliveryTo == null || obj.idDeliveryTo == 1)
            ) {
              $scope.ticket.delivery.idDeliveryTo = null;
              ...
              obj.whoPickUp.id == undefined &&
              $scope.ticket.delivery.idTypeDeliveryKf == 2 &&
              (obj.idDeliveryTo == null || obj.idDeliveryTo == 2)
            ) {
              $scope.ticket.delivery.thirdPerson = null;
              $scope.ticket.delivery.idDeliveryTo = null;
              if ($scope.ticket.delivery.otherAddress != undefined) {
                inform.add(
                  "Completar todos datos de la dirección a la cual sera enviado el pedido, para continuar.",
                  {
                    ttl: 5000,
                    type: "warning",
                  },
                );
                $("#RegisterDeliveryToOtherAddress").modal({
                  backdrop: "static",
                  keyboard: true,
                });
              } else {
        ...
        case "selectDeliveryAddress":
          ...
          if ($scope.ticket.delivery.whoPickUp.id == undefined) {
            inform.add(
              "Seleccionar/Indicar la direccion a la cual se hara la entrega del pedido.",
              {
                ttl: 5000,
                type: "info",
              },
            );
            $("#selectDeliveryAddress").modal({
              backdrop: "static",
              keyboard: true,
            });
          }
        ...
        case "setDeliveryAttendant":
          ...
          if ($scope.ticket.delivery.idTypeDeliveryKf == 1) {
            inform.add(
              "El encargado " +
                obj.fullNameUser +
                " retirara el pedido en la oficina.",
              {
                ttl: 5000,
                type: "success",
              },
            ...
            inform.add(
              "El encargado " +
                obj.fullNameUser +
                " recibira el pedido en el domicilio.",
              {
                ttl: 5000,
                type: "success",
              },
        ...
        case "setDeliveryUser":
          if (
            $scope.ticket.delivery.idTypeDeliveryKf == "2" &&
            $scope.ticket.delivery.idDeliveryTo != 2
          ) {
        ...
        case "setDeliveryCompany":
          ...
          $scope.update.ticket.history.push({
            idUserKf: $scope.sysLoggedUser.idUser,
            descripcion: obj.deliveryCompany.deliveryCompanyName,
            idCambiosTicketKf: "41",
          });
          $scope.update.ticket.idTicket = obj.idTicket;
          $scope.update.ticket.idDeliveryCompanyKf =
            obj.deliveryCompany.idDeliveryCompany;
          if (
            (obj.whereKeysAreEnable == "1" || obj.whereKeysAreEnable == "2") &&
            obj.isKeysEnable == "1"
          ) {
            $scope.update.ticket.idNewStatusKf = "4";
            $scope.update.ticket.history.push({
          ...
          console.info(
            "Delivery Id : " + obj.deliveryCompany.idDeliveryCompany,
          );
          console.info(
            "Delivery    : " + obj.deliveryCompany.deliveryCompanyName,
          );
          ...
          if (obj.idTypeDeliveryKf == "2") {
            if (obj.idStatusTicketKf == "5") {
              ...
              $scope.ticket.delivery_schedule_at =
                $scope.ticket.delivery_schedule_at;
              $scope.ticket.newTicketStatus =
                $scope.listStatusTicketChange.find((s) => s.idStatus == "1");
            }
          } else {
            $scope.ticket.deliveryDate = new Date();
            if ($scope.ticket.idWhoPickUp == "1") {
        ...
        case "applyTicketDelivered":
          ...
          var delivered_at =
            ...
            obj.deliveryDate != undefined
              ...
              : new Date();
          $scope.update.ticket.delivery_schedule_at =
            obj.delivery_schedule_at != null &&
            obj.delivery_schedule_at != undefined
              ? obj.delivery_schedule_at
              : null;
        ...
        case "ticketDisabledKeys":
          ...
          $scope.update.ticket.history.push({
            idUserKf: $scope.sysLoggedUser.idUser,
            descripcion: null,
            idCambiosTicketKf: "47",
          });
          $scope.update.ticket.history.push({
            idUserKf: $scope.sysLoggedUser.idUser,
            descripcion: null,
            idCambiosTicketKf: "48",
          });
          $scope.update.ticket.idUserActionKf = $scope.sysLoggedUser.idUser;
          console.log($scope.update);
          $("#changeModalStatus").modal("hide");
        ...
        case "isTechnicianAssigned":
          ...
          if ($scope.update.ticket.isTechnicianAssigned == 1) {
            $scope.update.ticket.history.push({
              idUserKf: $scope.sysLoggedUser.idUser,
              descripcion: null,
              idCambiosTicketKf: "49",
            });
          }
          $scope.update.ticket.idUserActionKf = $scope.sysLoggedUser.idUser;
          console.log($scope.update);
        ...
        case "deliveryToOtherAddress":
          ...
          if ($scope.ticket.delivery.otherAddress == null) {
            $scope.ticket.delivery.otherAddress = {
          ...
          $scope.selectedUserToDelivery =
            obj.whoPickUp != undefined ? obj.whoPickUp : obj;
          if ($scope.ticket.delivery.whoPickUp.id == undefined) {
            inform.add(
              "Completar los campos de direccion a la cual se hara la entrega del pedido.",
              {
                ttl: 5000,
                type: "info",
              },
        ...
        case "setDeliveryToOtherAddress":
          ...
          inform.add(
            "El " +
              ...
              " " +
              obj2.fullNameUser +
              " recibira el pedido en el domicilio indicado.",
            {
              ttl: 5000,
              type: "success",
            },
        ...
        case "checkThirdPersonLocation":
          UtilitiesServices.checkZonaByLocationAndCustomerId(
            $scope.ticket.building.idClient,
            obj.idLocation,
          ).then(function (response) {
            if (response.status == 200) {
              ...
              inform.add(
                "El envio a la localidad seleccionada tendra un recargo extra, contacta al area de soporte de Bss.",
                {
                  ttl: 8000,
                  type: "info",
                },
        ...
        case "setThirdPersonData":
          ...
          if ($scope.ticket.delivery.idTypeDeliveryKf != 1) {
            ...
            $scope.ticket.delivery.thirdPerson.address =
              streetName.toUpperCase() + " " + obj.streetNumber;
          }
          $scope.ticket.delivery.deliveryTo =
            $scope.ticket.delivery.thirdPerson;
          console.log($scope.ticket);
          $("#RegisterThirdPerson").modal("hide");
          if ($scope.ticket.delivery.idTypeDeliveryKf == 1) {
            inform.add(
              "El Pedido sera retirado por " +
                obj.fullNameUser +
                " en la oficina.",
              {
                ttl: 5000,
        ...
        case "setCosts":
          ...
          if (!$scope.costs.delivery.manual) {
            if ($scope.deliveryCostFree == 0) {
              if (
                ...
                if ($scope.ticket.delivery.idTypeDeliveryKf != 1) {
                  if (
                    ($scope.ticket.delivery.whoPickUp.id == undefined &&
                      $scope.ticket.delivery.idDeliveryTo != null &&
                      $scope.ticket.delivery.idDeliveryTo == 1) ||
                    ($scope.ticket.delivery.idDeliveryTo == null &&
                      $scope.ticket.delivery.whoPickUp.id == 2)
                  ) {
                    $scope.ticket.cost.delivery =
                      $scope.ticket.building.valor_envio;
                    ...
                    $scope.ticket.cost.delivery =
                      $scope.ticket.delivery.zone.valor_envio;
                    subTotalDelivery = Number(
                      $scope.ticket.delivery.zone.valor_envio,
                    );
                    $scope.costs.delivery.cost = subTotalDelivery.toFixed(2);
          ...
          subTotalCosts =
            Number(subTotalService) +
            Number(subTotalKeys) +
            Number(subTotalDelivery);
        ...
        case "recalculateCosts":
          ...
          subTotalCosts =
            NaN2Zero(Number(subTotalService)) +
            NaN2Zero(Number(subTotalKeys)) +
            NaN2Zero(Number(subTotalDelivery));
        ...
        case "linkMP": // Payment Link Mercado Pago
          ...
          $scope.mp.link.new.data = {
            idPago: null,
            monto: null,
            linkDeNotificacion: null,
            back_url: null,
            metadata: {},
          };
          $scope.mp.link.new.data.idTicket = obj.idTicket;
          $scope.mp.link.new.data.ticket_number = obj.codTicket;
          $scope.mp.link.new.data.monto = obj.createNewMPLinkForDelivery
            ? Number(parseInt(obj.costDelivery))
            : Number(parseInt(obj.total));
          ...
          $scope.mp.link.new.data.linkDeNotificacion =
            serverHost + "/Back/index.php/MercadoLibre/getNotificationOfMP";
          ...
          if (obj.createNewMPLinkForDelivery) {
            ...
            $scope.mp.link.new.data.mp_preference_id =
              obj.paymentDetails.mp_preference_id;
            $scope.mp.link.new.data.metadata.createdBy =
              $scope.sysLoggedUser.idUser;
          } else if (
            !obj.createNewMPLinkForDelivery &&
            obj.idPaymentKf != null &&
            obj.idPaymentKf != undefined
          ) {
          ...
          $scope.mp.link.new.data.metadata.paymentFor =
            obj.createNewMPLinkForDelivery ? 3 : 1;
      ...
      KeysServices.addKey(llavero).then(function (response) {
        if (response.status == 200) {
          ...
          ticketServices
            ...
            .then(function (response_ticke_keychain) {
              ...
              if (response_ticke_keychain.status == 200) {
                ...
                console.log(
                  "There was an error adding the key, contact administrator",
                );
                inform.add("Error: [500] Contacta al area de soporte. ", {
                  ttl: 5000,
                  type: "danger",
          ...
          inform.add(
            "Info: [203] El Codigo (" +
              llavero.llavero.codigo +
              "), del llavero, ya se encuentra registrado. ",
            {
              ttl: 5000,
              type: "warning",
            },
    ...
    $scope.deleteKeyFn = function (llavero) {
      ...
      KeysServices.deleteKey(llavero).then(function (response) {
        if (response.status == 200) {
          ticketServices
            ...
            .then(function (response_ticke_keychain) {
              if (response_ticke_keychain.status == 200) {
                ...
                inform.add(
                  "Los datos del llavero (" +
                    llavero.llavero.codigo +
                    ") han sido Eliminado con exito. ",
                  {
                    ttl: 4000,
                    type: "success",
                  },
                ...
                console.log(
                  "the key has not been updated, contact administrator",
                );
                inform.add("Error: [500] Contacta al area de soporte. ", {
                  ttl: 5000,
                  type: "danger",
          ...
          console.log(
            "There was an error removing the key, contact administrator",
          );
          inform.add("Error: [500] Contacta al area de soporte. ", {
            ttl: 5000,
            type: "danger",
        ...
        if (response.status == 200) {
          $timeout(function () {
            ...
            if (pedido.ticket.createNewMPLinkForDelivery != undefined) {
              response.data.response.createNewMPLinkForDelivery =
                pedido.ticket.createNewMPLinkForDelivery;
            }
          }, 2500);
          if (
            (pedido.ticket.createNewMPLink ||
              pedido.ticket.createNewMPLinkForDelivery) &&
            response.data.response.idTypePaymentKf == "2"
          ) {
            $timeout(function () {
    ...
    $scope.mpCreateLinkFn = function (data) {
      ticketServices.createMPLink(data).then(function (response) {
        ...
        if (response.status == 200 || response.status == 201) {
          if (
            response.data[0].data != undefined &&
            response.data[0].data != null &&
            ...
            $scope.mp.link.url =
              response.data[0].data.response.sandbox_init_point;
            ...
            inform.add(
              "Link de pago no ha sido generado satisfactoriamente. ",
              {
                ttl: 5000,
                type: "danger",
              },
    ...
    $scope.addPaymentFn = function (payment) {
      ...
      $scope.mp.payment.data.mp_preference_id =
        $scope.mp.link.new.data.mp_preference_id != null
          ? $scope.mp.link.new.data.mp_preference_id
          : null;
      console.log($scope.mp.payment.data);
      $scope.mp.payment.data.paymentForDelivery = $scope.update.ticket
        .createNewMPLinkForDelivery
        ? $scope.update.ticket.createNewMPLinkForDelivery
        : false;
      $scope.addPaymentDetailsFn = null;
      console.log($scope.mp.payment.data);
      ...
      ticketServices.setKeysEnableDisable(pedido).then(function (response) {
        ...
        if (response.status == 200) {
          $timeout(function () {
            console.log("Request Successfully processed");
            console.log(
              "pedido.ticket.idMgmtMethodKf  : " + pedido.ticket.idMgmtMethodKf,
            );
            console.log(
              "pedido.ticket.keysMethod.name : " +
                pedido.ticket.keysMethod.name,
            );
            switch (pedido.ticket.idMgmtMethodKf) {
              case "1":
                switch (pedido.ticket.idTypeRequestFor) {
                  ...
                  case "6":
                    console.log(
                      "pedido.ticket.idTypeRequestFor  : " +
                        pedido.ticket.idTypeRequestFor,
                    );
                    console.log(
                      "pedido.ticket.whereKeysAreEnable: " +
                        pedido.ticket.whereKeysAreEnable,
                    );
                    console.log(
                      "pedido.ticket.isKeysEnable      : " +
                        pedido.ticket.isKeysEnable,
                    );
                    if (
                      pedido.ticket.whereKeysAreEnable != null &&
                      pedido.ticket.whereKeysAreEnable == "2" &&
                      pedido.ticket.isKeysEnable == "1"
                    ) {
                ...
                switch (pedido.ticket.idTypeRequestFor) {
                  ...
                  case "2":
                    if (
                      ...
                      pedido.ticket.whereKeysAreEnable != null &&
                      pedido.ticket.whereKeysAreEnable == "1" &&
                      pedido.ticket.isKeysEnable == "1"
                    ) {
                      if (pedido.ticket.building.isStockInBuilding == "1") {
                        console.log("setDeliveryPending");
        ...
        if (response.status == 200) {
          $timeout(function () {
            ...
            if (pedido.ticket.idNewStatusKf == "4") {
              ...
              inform.add(
                "Pedido en Preparación, pendiente habilitación de llaveros. ",
                {
                  ttl: 5000,
                  type: "success",
                },
    ...
    $scope.sysApproveTicketFn = function (ticket) {
      console.clear();
      $scope.data = {
        ticket: { idTicket: null, idTypePaymentKf: null, history: [] },
      };
      ...
      ticketServices.approvedTicket($scope.data).then(function (response) {
        ...
        if (response.status == 200) {
          ...
          $timeout(function () {
            if (
              ticket.idTypePaymentKf == "2" &&
              ticket.idStatusTicketKf != 9 &&
              ticket.idStatusTicketKf != 11
            ) {
    ...
    $scope.setBillingInitiateFn = function (ticket) {
      ticketServices.seBillingInitiate(ticket).then(function (response) {
        ...
        if (response.status == 404) {
          inform.add(
            "Error: [404] Pedido no encontrado, contacta conc el area de soporte. ",
            {
              ttl: 5000,
              type: "warning",
            },
          ...
          $scope.ticketRegistered = null;
          inform.add(
            "Error: [500] Server Error, contacta al area de soporte. ",
            {
              ttl: 5000,
              type: "danger",
            },
    ...
    $scope.listTickets = function (filter) {
      ...
      ticketServices.all(filter).then(function (response) {
        if (response.status == 200) {
          ...
          $scope.dashboard.tickets.total =
            response.data.response.dashboard.total;
          $scope.dashboard.tickets.approval_pending =
            response.data.response.dashboard.Aprobación_Pendiente;
          $scope.dashboard.tickets.canceled =
            response.data.response.dashboard.Cancelado;
          $scope.dashboard.tickets.completed =
            response.data.response.dashboard.Entregado;
          $scope.dashboard.tickets.payment_pending =
            response.data.response.dashboard.Pago_Pendiente;
          $scope.dashboard.tickets.in_progress =
            response.data.response.dashboard.En_preparacion;
          $scope.dashboard.tickets.in_progress_initial_delivery_active =
            response.data.response.dashboard.En_preparacion_entrega_inicial;
          $scope.dashboard.tickets.delivery_pending =
            response.data.response.dashboard.Pendiente_de_entrega;
          $scope.dashboard.tickets.in_transit =
            response.data.response.dashboard.En_Ruta;
          $scope.dashboard.tickets.pickup_ready =
            response.data.response.dashboard.Listo_para_Retirar;
          $scope.dashboard.tickets.canceled =
            response.data.response.dashboard.Cancelado;
          $scope.dashboard.tickets.down_request_pending =
            response.data.response.dashboard.Baja_pendiente;
          $scope.dashboard.tickets.cancel_pending =
            response.data.response.dashboard.Cancelacion_pendiente;
          $scope.dashboard.tickets.cancel_refund_pending =
            response.data.response.dashboard.Cancelado_reintegro_pendiente;
          $scope.totalTickets = $scope.listTickt.length;
        } else if (response.status == 404) {
          inform.add(
            "No se encontraron resultados verifique el filtro seleccionado o contacte al soporte de BSS.",
            {
              ttl: 3000,
              type: "info",
            },
    ...
    $scope.setRequestDefaultListAsArrayFn = function (obj) {
      console.log(obj);
      $scope.sheetName =
        "Listado de Pedidos - " + sysDay + sysMonth2Digit + sysYear;
      $scope.list_requests = [];

      for (var f in obj) {
        var depto =
          obj[f].idTypeRequestFor == 1 ? obj[f].department.departament : "";
        var floor = obj[f].idTypeRequestFor == 1 ? obj[f].department.floor : "";
        var Departamento =
          obj[f].idTypeRequestFor == 1
            ? floor + " - " + depto.toUpperCase()
            : "";
        var Envio =
          obj[f].typeDeliver != undefined
            ? obj[f].typeDeliver.typeDelivery
            : "";
        var Pago =
          obj[f].typePaymentKf != undefined
            ? obj[f].typePaymentKf.descripcion
            : "";
        var fullNameUser =
          obj[f].idUserRequestBy != null &&
          obj[f].userRequestBy != undefined &&
          obj[f].userRequestBy.fullNameUser != undefined
            ? obj[f].userRequestBy.fullNameUser
            : "no asignado";
    ...
    $scope.setRequestBillingListAsArrayFn = function (obj) {
      try {
        if (obj.length >= 1) {
          $scope.sheetName =
            "Pedidos a Facturar -" + sysDay + sysMonth2Digit + sysYear;
          $scope.list_requests = [];
          for (var f in obj) {
            //console.log(obj[f]);
            ...
            var priceFabric = 0;
            var floor =
              obj[f].idTypeRequestFor == "1" ? obj[f].department.floor : "";
            var depto =
              obj[f].idTypeRequestFor == "1"
                ? obj[f].department.departament
                : obj[f].typeRequestFor.name;
            var department =
              obj[f].idTypeRequestFor == "1"
                ? floor + " - " + depto.toUpperCase()
                : depto.toUpperCase();
            ...
            var dniUser =
              obj[f].idUserRequestBy != null &&
              obj[f].userRequestBy.dni != undefined
                ? obj[f].userRequestBy.dni
                : "no asignado";
    ...
    $scope.getAddressDetailsFn = function (addressName, idProvince) {
      ...
      $scope.ubicacion_lon = null;
      addressServices
        .getAddressByName(addressName, idProvince)
        .then(function (data) {
          console.log(data);
          if (data != null) {
            ...
            $scope.ubicacion_lon = null;
            inform.add(
              "Direccion no encontrada en la API del Servicio de Normalizacion de Datos Geograficos. ",
              {
                ttl: 4000,
                type: "danger",
              },
    ...
    $scope.setDeliveryExternalCompanyListAsArrayFn = function (obj) {
      ...
      for (var f in obj) {
        ...
        var whoReceive = "";
        var addressLat =
          obj[f].deliveryAddress != null &&
          obj[f].deliveryAddress != undefined &&
          obj[f].deliveryAddress.addressLat != undefined
            ? obj[f].deliveryAddress.addressLat
            : "No asignado";
        var addressLon =
          obj[f].deliveryAddress != null &&
          obj[f].deliveryAddress != undefined &&
          obj[f].deliveryAddress.addressLon != undefined
            ? obj[f].deliveryAddress.addressLon
            : "No asignado";
        if (obj[f].idDeliveryTo == "1" && obj[f].idWhoPickUp == "1") {
          //DELIVERY OWNER PERSON TO CURRENT ADDRESS
        ...
        } else if (obj[f].idDeliveryTo == "2" && obj[f].idWhoPickUp == "1") {
          //DELIVERY OWNER PERSON TO DIFFERENT ADDRESS
          ...
          address =
            address.toUpperCase() + " " + obj[f].otherDeliveryAddress.number;
          emailAddr = obj[f].userDelivery.emailUser;
          phoneNumberUser = obj[f].userDelivery.phoneNumberUser;
          dni = obj[f].userDelivery.dni;
          $scope.getAddressDetailsFn(
            address,
            obj[f].otherDeliveryAddress.idProvinceFk,
          );
          ubicacion_lat = $scope.ubicacion_lat;
          ubicacion_lon = $scope.ubicacion_lon;
          whoReceive = obj[f].userDelivery.fullNameUser;
        } else if (obj[f].idDeliveryTo == null && obj[f].idWhoPickUp == "2") {
          //DELIVERY ENCARGADO PERSON TO CURRENT ADDRESS
          ...
          ubicacion_lon = addressLon;
          whoReceive = obj[f].userDelivery.fullNameUser;
        } else if (obj[f].idDeliveryTo == null && obj[f].idWhoPickUp == "3") {
          ...
          address =
            address.toUpperCase() + " " + obj[f].thirdPersonDelivery.number;
          emailAddr =
            obj[f].userRequestBy != null && obj[f].userRequestBy != undefined
              ? obj[f].userRequestBy.emailUser
              : "No asignado";
          phoneNumberUser = obj[f].thirdPersonDelivery.movilPhone;
          dni = obj[f].thirdPersonDelivery.dni;
          $scope.getAddressDetailsFn(
            address,
            obj[f].thirdPersonDelivery.idProvinceFk,
          );
          ubicacion_lat = $scope.ubicacion_lat;
          ubicacion_lon = $scope.ubicacion_lon;
          whoReceive =
            obj[f].thirdPersonDelivery.fullName != undefined
              ? obj[f].thirdPersonDelivery.fullName
              : "No asignado";
        }
    ...
    $scope.downloadXLS = function (wout) {
      saveAs(
        new Blob([xdw(wout)], { type: "application/octet-stream" }),
        sheetName + ".xlsx",
      );
    };
        ...
        for (var i = 0; i < list.files.length; i++) {
          ...
          if ("|pdf|".indexOf(type) !== -1) {
            ...
            var name =
              ...
              "." +
              file.type.slice(file.type.lastIndexOf("/") + 1);
            var cleanFile = new File([file], name, {
              type: file.type,
            ...
            console.log(
              file.name + " with type " + file.type + " is not supported",
            );
      ...
      reader.onload = function (event) {
        ...
        $scope.$applyAsync(function ($scope) {
          ...
          if (position !== -1) {
            ...
            var ticketNumb = file.name
              .substr(position + 1, positionExt)
              .replace(/\.[^/.]+$/, "");
            if (Number.isInteger(Number(ticketId))) {
              ...
              ticketServices.ticketById(ticketId).then(function (response) {
                if (response.status == 200) {
                  ...
                  ticketServices
                    ...
                    .then(function (response) {
                      if (response.status == 404) {
                        ...
                        inform.add(
                          "[Info]: La factura del pedido " +
                            ticketNumb +
                            " ya se encuentra cargada, contacta el area de soporte. ",
                          {
                            ttl: 5000,
                            type: "info",
                          },
                  ...
                  inform.add(
                    "[Error]: El Numero de pedido " +
                      ticketNumb +
                      " no ha sido encontrado o el archivo no cumple con la nomenclatura esperada, contacta el area de soporte. ",
                    {
                      ttl: 5000,
                      type: "danger",
                    },
              ...
              inform.add(
                "[Error]: El archivo " +
                  file.name +
                  " no cumple con la nomenclatura esperada intenta de nuevo o contacta el area de soporte. ",
                {
                  ttl: 5000,
                  type: "danger",
                },
      ...
      $scope.$apply(function ($scope) {
        for (var i = 0; i < list.files.length; i++) {
          ...
          var type =
            "|" + file.type.slice(file.type.lastIndexOf("/") + 1) + "|";
          if ("|pdf|".indexOf(type) !== -1) {
            var cleanFile = new File([file], fileName, {
              type: file.type,
              lastModified: file.lastModified,
              size: file.size,
            });
      ...
      for (var i = 0; i < $scope.fileListTmp.length; i++) {
        ...
        if ($scope.fileList.length > 0) {
          for (var key in $scope.fileList) {
            if (
              $scope.fileList[key].name == file.name &&
              $scope.fileList[key].type == file.type
            ) {
              inform.add(
                "El archivo: " + file.name + " ya se encuentra en la lista. ",
                {
                  ttl: 4000,
                  type: "warning",
                },
    ...
    $scope.uploadSingleFile = function (item) {
      ...
      for (var key in $scope.filesUploadList) {
        ...
        console.log(
          "$scope.filesUploadList[key].name :" +
            $scope.filesUploadList[key].name,
        );
        console.log(
          "$scope.filesUploadList[key].type :" +
            $scope.filesUploadList[key].type,
        );
        if (
          $scope.filesUploadList[key].size == item.size &&
          $scope.filesUploadList[key].lastModified == item.lastModified &&
          $scope.filesUploadList[key].type == item.type
        ) {
    ...
    $scope.uploadFilesFn = function (file, idTicketKf, item) {
      ...
      //console.log(item);
      ticketServices
        .uploadTicketFiles(file, idTicketKf)
        .then(function (rsupload) {
          //console.log(rsupload);
          if (rsupload.status == 200) {
            $scope.uploadTicketData.idTicketKf = rsupload.data.idTicketKf;
            $scope.uploadTicketData.urlFile =
              rsupload.data.dir + rsupload.data.filename;
            ...
            $scope.uploadTicketData.history.push({
              idUserKf: $scope.sysLoggedUser.idUser,
              descripcion: null,
            ...
            ticketServices
              .addUploadedTicketFile($scope.uploadTicketData)
              .then(function (response) {
                if (response.status == 200) {
                  ticketServices
                    .setIsBillingUploaded($scope.uploadTicketData.idTicketKf, 1)
                    .then(function (rsBillingUploaded) {
                      if (rsBillingUploaded.status == 200) {
                        var fileName =
                          item.fileTitle == "" ? item.name : item.fileTitle;
                        inform.add(
                          "Archivo " +
                            fileName +
                        ...
                        if ($scope.isUploadSingleFile) {
                          ...
                          $scope.mainSwitchFn("search", null);
                          $scope.openTicketFn(
                            $scope.uploadTicketData.idTicketKf,
                          );
                        }
                      }
                    });
                  ...
                  console.log(
                    "file uploaded not added into the db, contact administrator",
                  );
                  inform.add("Error: [500] Contacta al area de soporte. ", {
                    ttl: 20000,
                    type: "danger",
            ...
            inform.add(
              "Error: [404] Ocurrio un error al subir el archivo " +
                fileName +
                " Contacta al area de soporte. ",
              {
                ttl: 20000,
                type: "danger",
              },
            ...
            inform.add(
              "Error: [500][uploadTicketFiles] Ocurrio un error en el servidor, Contacta al area de soporte. ",
              {
                ttl: 20000,
                type: "danger",
              },
    ...
    $scope.uploadAllFiles_old = function (fileList) {
      ...
      for (var item in fileList) {
        ...
        if (fileList[item].uploadStatus == false) {
          for (var key in $scope.filesUploadList) {
            if (
              $scope.filesUploadList[key].name == fileList[item].name &&
              $scope.filesUploadList[key].type == fileList[item].type
            ) {
      ...
      angular.forEach(fileList, function (file) {
        ...
        $timeout(function () {
          ...
          ticketServices
            .uploadTicketFiles(file.obj, file.idTicketKf)
            .then(function (rsupload) {
              if (rsupload.status == 200) {
                $scope.uploadTicketData = {};
                $scope.uploadTicketData.idTicketKf = rsupload.data.idTicketKf;
    ...
    $scope.uploadAllFiles = function (fileList) {
      ...
      angular.forEach(fileList, function (file) {
        ...
        let fileObj = $scope.filesUploadList.find(
        ...
        ticketServices
          ...
          .then((rsupload) => {
            ...
            return ticketServices
              .addUploadedTicketFile(uploadTicketData)
          ...
          .then(({ response, uploadTicketData }) => {
            if (response.status !== 200) {
              throw {
                ...
                message: "Error adding file to DB",
              };
            }

            // Mark as billing uploaded (Uses correct `uploadTicketData`)
            return ticketServices.setIsBillingUploaded(
              uploadTicketData.idTicketKf,
              1,
            );
          })
          .then((rsBillingUploaded) => {
            if (rsBillingUploaded.status !== 200) {
              throw {
                status: rsBillingUploaded.status,
    ...
    $scope.clearFilesQueue = function (opt) {
      ...
      if (opt == null || opt == undefined) {
        inform.add(
          "Todos los archivos han sido removidos de la lista correctamente.",
          {
            ttl: 5000,
            type: "success",
          },
    ...
    $scope.deleteFilesFn = function (file) {
      ...
      //console.log(item);
      ticketServices
        .deleteTicketFiles(file.title)
        .then(function (rsdeletedFile) {
          ...
          if (rsdeletedFile.status == 200) {
            ...
            $scope.removeTicketData.history.push({
              idUserKf: $scope.sysLoggedUser.idUser,
              descripcion: null,
              idCambiosTicketKf: "21",
            });
            console.log($scope.removeTicketData);
            ticketServices
              .deleteUploadedTicketFile($scope.removeTicketData)
              .then(function (response) {
                if (response.status == 200) {
                  ticketServices
                    .setIsBillingUploaded(
                      $scope.removeTicketData.idTicketKf,
                      null,
                    )
                    .then(function (rsBillingRemoved) {
                      if (rsBillingRemoved.status == 200) {
                        inform.add(
                          "Archivo " +
                            $scope.removeTicketData.name +
                  ...
                  console.log(
                    "file deleted not removed into the db, contact administrator",
                  );
                  inform.add("Error: [500] Contacta al area de soporte. ", {
                    ttl: 20000,
                    type: "danger",
            ...
            inform.add(
              "Error: [404] Ocurrio un error al eliminar el archivo " +
                fileName +
                " Contacta al area de soporte. ",
              {
                ttl: 20000,
    ...
    $scope.isDeliveryDisabled = function (tk) {
      return (
        (tk.isInitialDeliveryActive == undefined ||
          tk.isInitialDeliveryActive == null ||
          tk.isInitialDeliveryActive == "0") &&
        tk.idTypeTicketKf < 2 &&
        tk.isDeliveryHasChanged != 1 &&
    ...
    $scope.isMPLinkDisabled = function (tk) {
      return (
        ...
        (tk.total != "0" &&
          ...
          tk.idStatusTicketKf != 1 &&
          tk.isCancelRequested != "1" &&
          (tk.paymentDetails.mp_payment_id == null ||
            tk.paymentDetails.mp_payment_id == 0 ||
            tk.paymentDetails.mp_payment_id == ""))
      );
    };
    ...
    if ($scope.sysRouteParams && $scope.sysRouteParams != undefined) {
      ...
      $timeout(function () {
        if (
          $scope.tkupdate.idTicket == undefined ||
          ($scope.tkupdate.idStatusTicketKf != "2" &&
            $scope.tkupdate.idStatusTicketKf != "9" &&
            $scope.tkupdate.idStatusTicketKf != "11")
        ) {
