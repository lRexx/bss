		...
		if (@$data['idProfileKf'] == '1' && (@$data['idClientAdminFk'] != '' || @$data['idClientCompaniFk'] != '')) {
			...
			if (@$data['idStatusTicketKf'] != '') {
				if (@$data['idStatusTicketKf'] == '10') {
					$where = "isCancelRequested = 1 AND idStatusTicketKf = " . @$data['idStatusTicketKf'];
					$this->db->where($where);
				} else if (@$data['idDeviceTypeKf'] != '' && @$data['idDeviceTypeKf'] != null && @$data['idDeviceTypeKf'] != '2' && @$data['idStatusTicketKf'] == '8' && @$data['idMgmtMethodKf'] == null && @$data['whereKeysAreEnable'] == null && @$data['isKeysEnable'] == null) {
