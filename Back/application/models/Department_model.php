            ...
            if ($queryBuilding->num_rows() > 0) {
                ...
                if ($building['idUserKf'] != null) {
                    ...
                    if ($queryUser->num_rows() > 0) {
                        ...
                        $body.='</tr>';
                        $body.='<tr width="100%" bgcolor="#ffffff">';
                        $body.= '<td width="100%" align="left" valign="middle" style="font-size:1vw; font-family: sans-serif; padding-left:4%;padding-right:4%">Ya podes utilizar nuestra plataforma de autogestión. &nbsp;</td>';
                        $body.='</tr>';
                        $body.='<tr width="100%" bgcolor="#ffffff">';
